...
Begin VB.Form frmPOSMain 
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   2925
      Left            =   60
      OleObjectBlob   =   "frmPOSMain8.frx":038A
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   255
      Width           =   12000
   ...
   Begin TrueOleDBGrid60.TDBGrid G4 
      Height          =   2070
      Left            =   45
      OleObjectBlob   =   "frmPOSMain8.frx":5421
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   75
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G2 
      Height          =   1380
      Left            =   45
      OleObjectBlob   =   "frmPOSMain8.frx":AE30
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   3870
      Width           =   4485
   ...
   Begin TrueOleDBGrid60.TDBGrid G5 
      Height          =   2010
      Left            =   1950
      OleObjectBlob   =   "frmPOSMain8.frx":E4A3
      TabIndex        =   14
      TabStop         =   0   'False
      Top             =   855
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G3 
      Height          =   2400
      Left            =   1500
      OleObjectBlob   =   "frmPOSMain8.frx":1270A
      TabIndex        =   15
      TabStop         =   0   'False
      Top             =   765
      Visible         =   0   'False
      Width           =   8745
   End
   Begin OposPOSPrinter_1_11_LibCtl.OPOSPOSPrinter OPOSPOSPrinterPosiflex 
      Left            =   11355
      OleObjectBlob   =   "frmPOSMain8.frx":17C61
      Top             =   6510
   End
   Begin OposCashDrawer_1_11_LibCtl.OPOSCashDrawer OPOSCashDrawerPosiflex 
      Left            =   11370
      OleObjectBlob   =   "frmPOSMain8.frx":17C85
      Top             =   6165
   End
...
'
    ...
    lblCustomername.TOP = lngDiff
    lblChange.TOP = lngDiff - 1200
    lblChange.Width = Me.Width - lblChange.Left - 1200
    lblPrompt.TOP = lngDiff + 1400
    txtPaymentTotal.TOP = NonNegative_Lng(lngDiff - 1100)
...
Private Sub mnusavecol_Click()
    On Error GoTo ErrHandler
    SaveLayout Me.G4, Me.Name & "B", Me.Height, Me.Width
    SaveLayout Me.G1, Me.Name & "A", Me.Height, Me.Width
'errHandler:
'    If ErrMustStop Then Debug.Assert False: Resume
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.mnusavecol_Click"
End Sub
...
'ErrHandler:
'    If ErrMustStop Then Debug.Assert False: Resume
'    ErrorIn "frmPOSMain.qTimer_Tick"
End Sub
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.SVREvent_Arrived(Queue,Cursor)", Array(Queue, Cursor)
End Sub
...
10        On Error GoTo ErrHandler
      ...
      Dim i As Integer
              'SaveSetting "POS", "StartDatabaseName", "DBNAME", IIf(oPC.DatabaseName = "PBKSFD", "PBKSFD_TEST", "PBKSFD")
20        For i = 1 To G1.Columns.Count
30            G1.Columns(i - 1).Width = GetSetting("PBKS", Me.Name & "A", CStr(i), G1.Columns(i - 1).Width)
40        Next
50        For i = 1 To G4.Columns.Count
60            G4.Columns(i - 1).Width = GetSetting("PBKS", Me.Name & "B", CStr(i), G4.Columns(i - 1).Width)
70        Next
...
130       bUpdating = False
140       bEnvironmentOK = True
150       ESC = Chr(27)
160       iToVoid = 0
          'Try to load local DB connection
170       If oPC Is Nothing Then
180           Set oPC = New z_POSCLIConnection
190           If UBound(arCommandLine) >= 1 Then
200               oPC.DatabaseName = arCommandLine(0)
210           Else
220               strDBName = GetSetting("POS", "StartDatabaseName", "DBNAME", "PBKSFD")
230               If strDBName = "" Then
240                   oPC.DatabaseName = "PBKSFD"
250                   oPC.UseTestDatabase = False
260               Else
270                   oPC.UseTestDatabase = False
280                   oPC.DatabaseName = strDBName
290               End If
300           End If
310       strPos = "2"
      ...
      '        End If
320           mnuSwaptoTest.Caption = IIf(oPC.DatabaseName = "PBKSFD", "Swap to TEST database", "Swap to LIVE database")
330           oPC.InitializeSettings
340           oPC.dbConnect
350           oPC.LoadProperties
360           oPC.loadRoundingRules
370           oPC.loadMultibuys
380           If oPC.ServerIPAddress <> oPC.NameOfPC Then
390               SynchronizeTOD oPC.ServerIPAddress
400           End If
410       End If
420       strPos = "3"
430       bLoggedOnAlready = False
440       bLogonOK = True
450       oPC.SetupZSession lngStaffID, strName
      '    MsgBox "oPC.ZSession.SupervisorID=" & oPC.ZSession.SupervisorID & " PC.GetProperty(CaptureFloat): " & oPC.GetProperty("CaptureFloat")
460       If oPC.ZSession.SupervisorID = 0 Then
470           If oPC.GetProperty("CaptureFloat") = "TRUE" Then
480               bGetFloat = True
490           Else
500               bGetFloat = False
510           End If
520           LogonOperator bGetFloat, dblFLoat, sFloatBreakdown
530           If bLogonOK = False Then
540               bCloseZsession = True
550               GoTo EXITHANDLER
560           End If
570           oPC.ZSession.SupervisorID = lngStaffID
580           oPC.ZSession.SupervisorName = strName
590           bLoggedOnAlready = True
600       End If
610       strPos = "4"
620       If oPC.ZSession.LoadOpenXSession = False Then
630           oPC.ZSession.OpSession.Start_OP_Session oPC.ZSession.Current_Z_Session_ID, lngStaffID
640           If oPC.ZSession.OpSession.SupervisorID = 0 Then
650               If bLoggedOnAlready = False Then
660                   If oPC.GetProperty("CaptureFloat") = "TRUE" Then
670                       bGetFloat = True
680                   Else
690                       bGetFloat = False
700                   End If
710                   LogonOperator bGetFloat, dblFLoat, sFloatBreakdown
720                   If bLogonOK = False Then
730                       bCloseXsession = True
740                       bCloseZsession = True
750                       GoTo EXITHANDLER
760                   End If
770               End If
780               oPC.OpenLocalDatabase
790               oPC.ZSession.OpSession.SetOperatorID lngStaffID, dblFLoat, sFloatBreakdown
                 ' oPC.ZSession.OpSession.OperatorID = lngStaffID
800               oPC.ZSession.OpSession.Name = strName
810               oPC.CloseLocalDatabase
820           End If
830       End If
840       strPos = "5"
850       SetForCOLSVisible False
860       If oPC.UseCashDrawer Then
870           If oPC.DriveDrawer = True Then  'There is a COM connected Cash Drawer
880               MSComm1.Settings = oPC.COMPORTSettings
890               MSComm1.CommPort = oPC.CashDrawerPort
900               If MSComm1.PortOpen = False Then
910                   MSComm1.PortOpen = True
920               End If
930           Else                            'There is a cash drawer connected to the Printer
940               If oPC.GetProperty("ReceiptPrinterType") = "" Or oPC.GetProperty("ReceiptPrinterType") = "Epson" Then
950                   OPOSCashDrawer1.DeviceEnabled = True
960               Else
970                   OPOSCashDrawerPosiflex.DeviceEnabled = True
980               End If
990           End If
1000      End If
1010      strPos = "6"
1020      If oPC.PrintSlips Then
1030          strPos = "6.1"
1040          If oPC.UseA4Printer = False Then
1050          strPos = "6.2"
1060             SetupPrinter
1070          strPos = "6.3"
1080              If oPC.UseCashDrawer Then
1090          strPos = "6.4"
1100                  SetupCashDrawer
1110              End If
1120          Else
1130          strPos = "6.3"
1140              Printer.FontName = "COURIER"
1150              Printer.FontSize = 12
1160              iColWidth = 50
1170          End If
1180      End If
1190      strPos = "7"
1200      If Not bEnvironmentOK Then
1210          GoTo EXITHANDLER
1220      End If
1230      LoadVoucherTypes
1240      LoadDiscountTypes
1250      txtInput.BackColor = RGB(230, 250, 210)
          
1260      G1.Array = X1
1270      G4.Height = 380
1280      If oPC.DatabaseName <> "PBKSFD_TEST" Then
1290          ReSendExchanges
1300      End If
1310      strPos = "8"
1320      X4.Clear
1330      X4.ReDim 1, 0, 1, 13
1340      LoadExchanges
1350      SetupQueues
          
1360      Set qTimer = New XTimer
1370      qTimer.Interval = 10000
1380      qTimer.Enabled = True
          
1390      If oPC.DatabaseName = "PBKSFD_TEST" Then
1400          Me.BackColor = vbRed
1410      End If
...
10        If oPC.PrintSlips = True Then
20            If oPC.GetProperty("ReceiptPrinterType") = "" Or oPC.GetProperty("ReceiptPrinterType") = "Epson" Then
'MsgBox "position 1"
30                Set OPOSPrinter = OPOSPOSPrinter1
40            ElseIf oPC.GetProperty("ReceiptPrinterType") = "Posiflex" Then
'MsgBox "position 2"
50                Set OPOSPrinter = OPOSPOSPrinterPosiflex
60            End If
               '       MsgBox "Trying to set up Epson Printer name is " & oPC.Printername
70            With OPOSPrinter
80                lngResult = .Open(oPC.Printername)
90                If lngResult = 0 Then
100                   lngResult = .ClaimDevice(5)
...
160                       .RecLineChars = 40
                       '   MsgBox "Successfully claimed printer"
170                   Else
180                       MsgBox "The till printer (" & oPC.Printername & ") is not online. This application will close."
190                       bEnvironmentOK = False
200                       Exit Sub
210                   End If
220               Else
230                   MsgBox "The till printer is not online. This application will close."
240                   bEnvironmentOK = False
250                   Exit Sub
260               End If
270           End With
280       End If
290       Me.lblState.Visible = False

'errHandler:
'    If ErrMustStop Then Debug.Assert False: Resume
'    ErrorIn "frmPOSMain.SetupPrinter"
    Exit Sub
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.SetupPrinter"
...
Dim lngResult As Long
    ...
    If oPC.DriveDrawer = False Then
        If oPC.GetProperty("ReceiptPrinterType") = "" Or oPC.GetProperty("ReceiptPrinterType") = "Epson" Then
            Set OPOSCashDrawer = OPOSCashDrawer1
        ElseIf oPC.GetProperty("ReceiptPrinterType") = "Posiflex" Then
            Set OPOSCashDrawer = OPOSCashDrawerPosiflex
        End If
        With OPOSCashDrawer
...
Private Sub CloseApplication(bCancel As Integer, Optional bForceClose As Boolean)
    ...
    If Not OPOSPrinter Is Nothing Then
    With OPOSPrinter
        .DeviceEnabled = False
        .ReleaseDevice
        .Close
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.Action_SaveSale"
End Function
...
30        If oExchange.NeedsCustomerInfo = True Then
...
350       If oExchange.CustomerToBeCredited Then 'THis is to determine in the case of an exchange (not a RDEP) if money is to go out
...
610           If oExchange.PaymentLines(i).PaymentType = "AC" And oExchange.transactionType <> "AR" Then  'A payment has been placed on account
620               oExchange.SetExchangeType eAccountSaleType
630           End If
640       Next i
650       oExchange.ApplyEdit
...
720       SendPOSExchange oExchange.ExchangeID, oExchange.ZID    'oExchange.OPSID,
      'Print Till Slip
730       If oPC.PrintSlips = True Then
740           Select Case oExchange.transactionType
              Case "S", "AR", "A", "CN"
750               If (oExchange.Customer.CustomerType = "L1" Or oExchange.Customer.CustomerType = "L2" Or oExchange.Customer.CustomerType = "L3") And (oExchange.LoyaltyValue > 0) Then
...
Private Sub PrepareForNewSale()
    On Error GoTo ErrHandler
10        On Error GoTo ErrHandler
20        Set oExchange = New a_Exchange
30        oExchange.BeginEdit
40        oExchange.SalesPersonID = oPC.ZSession.OpSession.OperatorID
50        oExchange.SetExchangeType eSaleType
60        ClearTextFields
70        X1.Clear
80        X1.ReDim 1, 1, 0, 8
90        G1.ReBind
100       X2.Clear
110       X2.ReDim 1, 1, 1, 3
120       G2.ReBind
130       txtInput.BackColor = RGB(230, 250, 210)
          
140       lblCustomername.Caption = vbNullString
150       lblReplacement.Visible = False
160       iCurrentSaleLine = 0
170       iCurrentPaymentLine = 0
180       iToVoid = 0
190       bSaleActive = False
200       bCustomerVisible = False
210       SetPresentState eStart
220       enMode = emode_Sale
230       SetTitleBar True
240       SetForCOLSVisible False
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.PrepareForNewSale"
End Sub
...
50        Set rs = oLU.GetProduct(strEAN, strCode, oExchange.Customer.CustomerType, bSuccess)
...
'errHandler:
'    If ErrMustStop Then Debug.Assert False: Resume
'    ErrorIn "frmPOSMain.RefreshSaleDisplay", , , , "i,oExchange.SaleLines.Count", Array(i, oExchange.SaleLines.Count)
    Exit Sub
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
...
50        X1.Value(MaxLines - Index + 1, 0) = Index
70        X1.Value(MaxLines - Index + 1, 1) = oExchange.SaleLines(Index).CodeF
90        X1.Value(MaxLines - Index + 1, 2) = IIf(enPresentState = eSelectDepositLine, "(DEP)", "") & oExchange.SaleLines(Index).title & " (" & oExchange.SaleLines(Index).MainAuthor & ")"
100       X1.Value(MaxLines - Index + 1, 3) = oExchange.SaleLines(Index).Qty
120       X1.Value(MaxLines - Index + 1, 4) = oExchange.SaleLines(Index).PriceF & IIf(oExchange.SaleLines(Index).IsSpecialPrice, "**", "")
130       X1.Value(MaxLines - Index + 1, 5) = oExchange.SaleLines(Index).DiscountRateF
150       X1.Value(MaxLines - Index + 1, 6) = oExchange.SaleLines(Index).PLessDiscExtF
170       If oExchange.transactionType <> "INV" Then
190           X1.Value(MaxLines - Index + 1, 7) = oExchange.SaleLines(Index).PLessDiscExtVATF & "(" & oExchange.SaleLines(Index).VATRateF & ")"
200       End If
220       G1.ReBind
230       G1.Refresh
...
'errHandler:
'260       If ErrMustStop Then Debug.Assert False: Resume
'270       ErrorIn "frmPOSMain.LoadSaleRow(Index,MaxLines)", Array(Index, MaxLines), , , "strPOS,line number", Array(strPos, Erl())
    Exit Sub
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.LoadSaleRow(Index,MaxLines)", Array(Index, MaxLines)
End Sub
...
' When outputting to a printer,a mouse cursor becomes like a hourglass.
    ...
    For c = 1 To pCopyCount
        If oPC.UseA4Printer Then
                ...
                ar2 = Split(ar(8), "|")
                For k = 1 To UBound(ar2)
                    ar3 = Split(ar2(k), "^^")
                    sBuf = ar3(0) & " " & Left(ar3(1), 25)
                    Printer.Print sBuf
                Next
                ...
                PrintTotals ConvertToType(oExchange.transactionType), OPOSPrinter, bReprint          'print totals
                PrintFooter c, ConvertToType(oExchange.transactionType), OPOSPrinter          'print footer
                Printer.Print ""
                Printer.EndDoc
        Else
    ...
    '           .PrintNormal PTR_S_RECEIPT, vbCrLf     'create gap
                ...
                .PrintNormal PTR_S_RECEIPT, vbCrLf + "Customer:" + vbLf
                sBuf = ar(1) & " " & ar(2) & " " & ar(3)
                .PrintNormal PTR_S_RECEIPT, sBuf + vbLf
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.PrintORDERSlip(pCopyCount,bReprint)", Array(pCopyCount, bReprint)
End Sub
...
' When outputting to a printer,a mouse cursor becomes like a hourglass.
    ...
    For c = 1 To pCopyCount
        If oPC.UseA4Printer Then
                PrintHeader eTypPettyCash, OPOSPrinter, bReprint          'Print header
                Printer.Print ""
...
Private Sub PrintHeader(eDocumentType As enumDocumentType, pPrinter As Object, Optional bReprint As Boolean)
    On Error GoTo ErrHandler
Dim fDate As String
Dim ar() As String
Dim i As Integer
...
Dim lngDepositValue As Long
    ...
    Else
        ...
        If frm.Cancelled Then
            Action_OrderRequest = eStart
        Else
            strRequestDetails = frm.GetDetailsXML
            strOrderedTitle = frm.GetDetailsForSlip
           ' strRequestDetails = frm.Customer & "~~" & frm.Item
            lngDepositValue = frm.Deposit
            oExchange.Note = strRequestDetails '& "~~" & frm.txtName & "~~" & "Deposit:" & Format((CDbl(lngDepositValue) / oPC.CurrencyDivisor), "###,##0.00")
...
''
    If strPrefix = ".." Then
        Action_Sale = eStart
    ElseIf InStr(2, txtInput, "/") > 0 Then 'We are going to edit a price
        arIP() = Split(txtInput, "/")
        If IsNumeric(arIP(0)) Then
            If CDbl(arIP(0)) < 32000 Then
                iLineNumber = CInt(arIP(0))
            Else
                iLineNumber = 0
            End If
            If CDbl(arIP(1)) < 1000000 Then
                lngEditedPrice = CLng(arIP(1))
            Else
                lngEditedPrice = 0
            End If
        End If
        If iLineNumber > 0 And iLineNumber <= oExchange.SaleLines.Count And lngEditedPrice > 0 Then
            oExchange.SaleLines(iLineNumber).BeginEdit
            oExchange.SaleLines(iLineNumber).SetPrice arIP(1)
            oExchange.SaleLines(iLineNumber).ApplyEdit
            oExchange.CalculateTotals True
            txtInput = ""

        Else
            MsgBox "Invalid entry for price alteration.", vbInformation, "Can't edit price"
        End If
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.Action_Sale"
End Function
...
Private Function Action_Price() As eState
    ...
    If Not oSALELine Is Nothing And strSuffix > "" Then
      If CDbl(strSuffix) < 10000000 Then  'Maximum price value
...
Dim frm As frmOD
        ...
        If CheckThisPoint(M_OPENDRAWER) Then
            If Not SecurityControl(enSECURITY_OPENDRAWER, lngOPID, strName, , "Enter your signature", "You do not have permission to perform Open Drawer action", True) Then
                Exit Function
            End If
        End If
        Set frm = New frmOD
...
10        On Error GoTo ErrHandler
      ...
      Dim bCancelled As Boolean
        ...
        If CheckThisPoint(M_VOID) Then
          If Not SecurityControl(enSECURITY_VOIDEXCHANGE, lngOPID, strName, , "Enter your signature.", "Your signature does not give you permission to void.", True) Then
              Action_Void = eStart
              Exit Function
          End If
        End If
...
120                       Else
130                           Res = False
140                           bCancelled = False
150                           Do Until Res = True Or bCancelled = True
160                               If CheckThisPoint(M_VOID) Then
170                                   If Not SecurityControl(enSECURITY_VOIDEXCHANGE, lngStaffID, strName, bCancelled, "Enter your signature.", "Your signature is invalid for this action", True) Then
180                                       Res = False
190                                   Else
200                                       Res = True
210                                   End If
...
250                           Loop
          ...
          '                        If IsRole(enSECURITY_ISSUPERVISOR, strPrefix, strName, lngOPID) = True Then
                              '        If bCancelled
260                           If Res = True Then
270                               lngOPID = lngStaffID
280                               oExchange.SalesPersonID = lngStaffID
...
450       Exit Function
'errHandler:
'460       If ErrMustStop Then Debug.Assert False: Resume
'470       ErrorIn "frmPOSMain.Action_Void"
'480       HandleError
    Exit Function
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.UpdateClientFromServerFiles(rs,msg)", Array(rs, msg)
End Sub
...
ErrHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.SaveApproRUpdate(rs)", rs
End Function
