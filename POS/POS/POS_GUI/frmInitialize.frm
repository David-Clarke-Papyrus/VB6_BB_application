...
errHandler:
    ...
    ErrorIn "frmInitialize.Componenet(oExchange)", oExchange
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.cmdCancel_Click", , EA_NORERAISE
    HandleError
End Sub
...
Private Sub cmdOK_Click()
    ...
    If Trim$(Me.txtServerPath) <> oEx.ServerPath Or Trim$(Me.txtTillCode) <> oEx.TillCode Then
        ...
        End If
    End If
    If Not oEx.RegisterWithServer() Then
        Canceled = True
    Else
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.cmdOK_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.CheckValid"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.cmdTest_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInitialize.txtServerPath_Change", , EA_NORERAISE
    HandleError
End Sub
