...
Dim fInit As frmInitialize
    ...
    If Not oEx.RecSetLoaded Then
        ...
        If Not oEx.RequestRSFromServer Then
            Unload fWait
            Set fWait = Nothing
            MsgBox "Retrieving missing data file from server failed!" & vbLf & _
...
PasswordInput:
    ...
    End If
    With oEx
        .AddExchange Val(Me.lblTotal), oGD.SalesPersonID, lSupervisorID, Val(Me.lblGDiscPercent) _
            , 0, sCustomer
        For Each lst In Me.lstItems.ListItems
            If lst.Text <> "" Then
                ...
                .AddSaleLine sPID, Val(lst.SubItems(SI_QTY)), Val(lst.SubItems(SI_UNITPR)), _
