...
Public bTryToCOnnectToMainServer As Boolean
Global mDBName As String
Dim frmMain As frmPOSMain
Public bForceClose As Boolean
...
Dim frmSplash As frmSplash
    ...
    Set frmMain = New frmPOSMain
    frmMain.Show
    If frmMain.GetEnvironmentstatus = True Then
        frmMain.StartSale
    Else
        Unload frmMain
        Set frmMain = Nothing
