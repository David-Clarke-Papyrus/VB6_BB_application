...
'comment/uncomment lines in ErrSaveToCnn method.
'
'Public members =========================================================================
'
...
'Public Function ErrSaveToCnn(ByVal ConnectString As String, _
...
Public Function ErrSaveToFile(Optional ByVal ErrFileName As String = "Errors.txt") As Boolean
    ...
    If ErrReport <> "" Then
        f = FreeFile
    '    FName = IIf(InStr(1, ErrFileName, "\") > 0, ErrFileName, oCnn.SharedFolderRoot & "\" & ErrFileName)
