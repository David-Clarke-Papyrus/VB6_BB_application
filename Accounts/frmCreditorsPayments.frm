...
Begin VB.Form frmCreditorsPayments 
   BackColor       =   &H00F7EDE8&
   Caption         =   "Creditors payments preparation"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   16470
   ...
   Begin VBControlManager.ControlManager CM 
      ...
      Begin VB.Frame fr3 
         ...
         Begin TrueOleDBGrid60.TDBGrid PaymentsGrid 
            Height          =   3240
            Left            =   180
            OleObjectBlob   =   "frmCreditorsPayments.frx":0000
            TabIndex        =   31
            Top             =   300
            Width           =   6300
         End
      ...
      Begin VB.Frame fr2 
         ...
         Begin TrueOleDBGrid60.TDBGrid LedgerGrid 
            Height          =   3240
            Left            =   30
            OleObjectBlob   =   "frmCreditorsPayments.frx":4C59
            TabIndex        =   29
            Top             =   1155
            Width           =   7845
         End
      ...
      Begin VB.Frame fr1 
         ...
         Begin TrueOleDBGrid60.TDBGrid Grid 
            Height          =   2265
            Left            =   705
            OleObjectBlob   =   "frmCreditorsPayments.frx":B084
            TabIndex        =   26
            Top             =   765
            Width           =   7095
         End
   ...
   End
End
Attribute VB_Name = "frmCreditorsPayments"
...
'    LedgerGrid.Array = XB
'    LedgerGrid.ReBind
'    LedgerGrid.Caption = oVendor.Fullname & " (" & oVendor.AcNo & ")"
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmDebtors.LoadLedgerGrid"
End Sub
...
Private Sub resize()
    ...
    Me.LedgerGrid.Left = fr2.Left + 50
    Me.LedgerGrid.Top = fr2.Top - fr1.Height + 300
    Me.LedgerGrid.Width = NonNegative_Lng(fr2.Width - 400)
    Me.LedgerGrid.Height = NonNegative_Lng(fr2.Height - 1000)
