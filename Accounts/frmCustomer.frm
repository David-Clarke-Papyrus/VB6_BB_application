...
Begin VB.Form frmCustomer 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "cboSalesRep"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "chkTemporary"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "txtNote"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "frInterestGroup"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "frCustomerClassification"
      ...
      Tab(2).Control(4)=   "cmdAdd"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "G1"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "cbBillTo"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "cbAppro"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "cbDelTo"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "cbOrderTo"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "Label12"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "lblRecords"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).ControlCount=   12
      TabCaption(3)   =   "Templates"
      TabPicture(3)   =   "frmCustomer.frx":0054
      ...
      Begin VB.ComboBox cboTerms 
         BackColor       =   &H80000018&
         Height          =   315
         ItemData        =   "frmCustomer.frx":03FA
         Left            =   1695
         List            =   "frmCustomer.frx":0411
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   1920
         Width           =   1755
      ...
      Begin TrueOleDBGrid60.TDBGrid G1 
         DragIcon        =   "frmCustomer.frx":0445
         Height          =   2355
         Left            =   -74865
         OleObjectBlob   =   "frmCustomer.frx":0887
         TabIndex        =   15
         Top             =   780
         Width           =   8325
      End
...
Dim bIsSupervisor As Boolean
   ' If SecurityControl(enSECURITY_BLOCK_DEBTORS, bCancelled, "Enter your signature", "You do not have permission to set debtors' blocking", bIsSupervisor) = True Then
