...
<script runat="server">
	...
	private void PopulateTree()
	{
		...
		try
		{
			FolderTree.SelectedNode.ImageUrl = "/Styles/Images/WSAT_Images/target.gif";
		}
		catch { }
        FolderTree.ExpandDepth = 1;
	}
	...
	protected void FolderTree_SelectedNodeChanged(object sender, EventArgs e)
	{
		...
		FolderTree.SelectedNode.ImageUrl = "/Styles/Images/WSAT_Images/target.gif"; // Set the newly selected folder's ImageUrl.
	}
	...
	private void ResetFolderImageUrls(TreeNode parentNode)
	{
		...
		parentNode.ImageUrl = "/Styles/Images/WSAT_Images/folder.gif";
		...
		<tr>
			<td valign="top" style="padding-right: 30px;">
				...
				<asp:TreeView runat="server" ID="FolderTree"
					...
					<RootNodeStyle ImageUrl="/Styles/Images/WSAT_Images/folder.gif" />
					<ParentNodeStyle ImageUrl="/Styles/Images/WSAT_Images/folder.gif" />
					<LeafNodeStyle ImageUrl="/Styles/Images/WSAT_Images/folder.gif" />
