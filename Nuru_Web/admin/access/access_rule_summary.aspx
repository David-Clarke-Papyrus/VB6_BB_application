...
<script runat="server">
	...
	private TreeNode AddNodeAndDescendents(string byUserOrRole, DirectoryInfo folder, TreeNode parentNode)
	{
		...
		node.ImageUrl = (action.Substring(0, 5) == "ALLOW") ? "~/Styles/Images/WSAT_Images/greenlight.gif" : "~/Styles/Images/WSAT_Images/redlight.gif";
		...
		foreach(DirectoryInfo subFolder in subFolders)
		{
			...
			if (subFolder.Name != "controls" && subFolder.Name != "App_Data")
			{
