Attribute VB_Name = "UDTGDN"
Public Type GDNProps
    GDNID As Long
...
End Type
Public Type GDNData
    buffer As String * 1258
End Type

Public Type GDNLProps
    Sequence As Long
    GDNLineID As Long
    GDNID As Long
    PIID As Long
    ...
    IsDeleted As Boolean
End Type
Public Type GDNLData
    buffer As String * 820
End Type
Public Type dGDNProps
    TRID As Long
    Qty As Long
    PIID As Long
    GDNLID As Long
