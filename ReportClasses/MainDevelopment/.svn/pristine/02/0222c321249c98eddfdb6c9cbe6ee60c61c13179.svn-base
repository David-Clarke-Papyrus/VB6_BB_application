...
Begin VB.Form frmInvoice 
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Left            =   7740
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmInvoicewSS.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   25
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Left            =   6720
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmInvoicewSS.frx":2B2C
      Style           =   1  'Graphical
      TabIndex        =   13
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.Frame fr1 
      ...
      Begin VB.CommandButton cmdFind 
         Height          =   345
         Left            =   1755
         Picture         =   "frmInvoicewSS.frx":2EB6
         Style           =   1  'Graphical
         TabIndex        =   1
         TabStop         =   0   'False
         Top             =   135
      ...
      Begin VB.CommandButton cmdEnter 
         ...
         Left            =   9585
         MaskColor       =   &H00C4BCA4&
         Picture         =   "frmInvoicewSS.frx":3240
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   1230
         Width           =   1050
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboRef 
         Height          =   345
         Left            =   165
         OleObjectBlob   =   "frmInvoicewSS.frx":35CA
         TabIndex        =   2
         Top             =   1275
         Visible         =   0   'False
         Width           =   6885
   ...
   Begin VB.CommandButton cmdIssue 
      ...
      Height          =   650
      Left            =   9780
      Picture         =   "frmInvoicewSS.frx":4974
      Style           =   1  'Graphical
      TabIndex        =   12
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.Image Image1 
      Height          =   255
      Left            =   3465
      Picture         =   "frmInvoicewSS.frx":4CFE
      Stretch         =   -1  'True
      Top             =   615
      Width           =   360
   End
...
'                End If
            ...
            flgLoading = False
        End If
 '       oInvoice.NonVATDocument = (oInvoice.Customer.VATable = False And oInvoice.Customer.ShowVAT = False)
