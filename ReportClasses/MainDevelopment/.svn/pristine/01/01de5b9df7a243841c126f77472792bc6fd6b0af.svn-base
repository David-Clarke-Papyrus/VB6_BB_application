...
Public Sub ErrSysHandlerRelease()
    ErrPreserve 'This Sub may be called from or ErrHandler, so ErrPreserve ors
...
Private Function GetExcAsText(ByVal ExcNum As Long) As String
    Select Case ExcNum
        ...
        Case SYSEXC_IN_PAGE_OR:             GetExcAsText = "In Page or"
