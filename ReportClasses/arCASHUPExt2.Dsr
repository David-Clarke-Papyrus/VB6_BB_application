VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arCashupExt2 
   ...
   _ExtentX        =   26988
   _ExtentY        =   25003
   SectionData     =   "arCASHUPExt2.dsx":0000
End
Attribute VB_Name = "arCashupExt2"
...
Dim arPC As arCashup_PettyCash
Dim oSQL As z_SQL
...
Public Sub component(pRs As ADODB.Recordset, pCredits As String, pWithdrawals As String, pNett As String, Optional ZID As String)
    If ZID = "" Then Me.Shape1.BackStyle = ddBKNormal
    Set rs = pRs
