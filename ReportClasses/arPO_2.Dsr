VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arPO_2 
   ...
   _ExtentX        =   32729
   _ExtentY        =   18071
   SectionData     =   "arPO_2.dsx":0000
End
Attribute VB_Name = "arPO_2"
...
Public Sub Component(pLineArray As Variant, pLineTotalArray As Variant, pLogofilename As String)
...
errHandler:
    ...
    ErrorIn "arPO_2.Component(pLineArray,pLineTotalArray)", Array(pLineArray, pLineTotalArray), _
         EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "arPO_2.Detail_Format", , EA_NORERAISE
    HandleError
End Sub
