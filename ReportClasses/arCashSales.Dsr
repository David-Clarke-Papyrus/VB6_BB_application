VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arCashSales 
   ...
   _ExtentX        =   26591
   _ExtentY        =   14526
   SectionData     =   "arCashSales.dsx":0000
End
Attribute VB_Name = "arCashSales"
...
Public Sub Component(pRs As ADODB.Recordset, pDate1 As Date, pDate2 As Date)
    ...
    lblRptHeader.Caption = "Front desk sales (by date) generated between " & Format(pDate1, "dd/mm/yyyy") _
