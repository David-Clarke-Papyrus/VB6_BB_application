VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arValidation_C 
   Caption         =   "arMissing"
   ClientHeight    =   6270
   ClientLeft      =   60
   ClientTop       =   345
   ...
   _ExtentX        =   26432
   _ExtentY        =   11060
   SectionData     =   "arValidation_C.dsx":0000
End
Attribute VB_Name = "arValidation_C"
...
Private Sub Detail_Format()
    ...
    Me.txtOnHand = FNN(rs.Fields("CNT"))
