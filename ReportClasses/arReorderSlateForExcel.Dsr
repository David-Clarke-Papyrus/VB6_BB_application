VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arReorderSlate_ForExcel 
   ...
   _ExtentX        =   33655
   _ExtentY        =   16695
   SectionData     =   "arReorderSlateForExcel.dsx":0000
End
Attribute VB_Name = "arReorderSlate_ForExcel"
...
Dim dteTMP As Date
    ...
    fSupplierName.DataField = "Extended"
    fTotal.DataField = "EXTENDED"
End Sub
