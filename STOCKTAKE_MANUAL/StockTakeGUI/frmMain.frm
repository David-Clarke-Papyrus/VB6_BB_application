...
Begin VB.Form frmMain 
   Caption         =   "Maunal Stock-take capture"
   ClientHeight    =   6480
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8700
...
Dim fc, fi
    ...
    strPath = gPapyConn.DatabaseFolder & "\Stocktke"
...
Private Sub txtFileName_Validate(KeepFocus As Boolean)
    ...
    strPath = gPapyConn.DatabaseFolder & "\Stocktke\" & txtFileName & ".txt"
...
Private Sub LoadListView(pCode As String, pTitle As String)
Dim lstItem As ListItem
...
Dim strCodeToWrite As String
    ...
    If KeyCode = vbKeyReturn Then
        ...
        oTxtList.WriteToLog txtNumber, strPath ' & "," & txtQty, strPath
        LoadListView txtNumber, oProd.Title
        txtNumber = ""
