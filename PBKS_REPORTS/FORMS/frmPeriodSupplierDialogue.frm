...
Begin VB.Form frmPeriodTPDialogue 
   BackColor       =   &H00D3D3CB&
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   615
      Left            =   5460
      Picture         =   "frmPeriodSupplierDialogue.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   10
      Top             =   1800
      Width           =   1000
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   4440
      Picture         =   "frmPeriodSupplierDialogue.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   9
      TabStop         =   0   'False
      Top             =   1800
   ...
   End
End
Attribute VB_Name = "frmPeriodTPDialogue"
