...
Begin VB.Form frmSupplier 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "cboDispatchMode"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "Frame1"
      Tab(0).Control(2)=   "cboCurr"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdEditDeal"
      Tab(0).Control(4)=   "cmdRemoveDeal"
      Tab(0).Control(5)=   "cmdAddDeal"
      Tab(0).Control(6)=   "lvwDeals"
      ...
      Tab(2).Control(9)=   "lblCurrencyConversionRate"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "Label15"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "txtParent"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "cmdKeep"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "txtEDINumber"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "txtReturnEndMonths"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "txtReturnStartMonths"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "chkActive"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "txtDefaultDeliverydays"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "chkVatable"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "txtRecordAdded"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "txtRecordLastChanged"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "chkDistributorOnly"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "txtEDIType"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "txtCurrencyConversionRate"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "txtFTPAddress"
...
Dim intPos As Integer
    On Error Resume Next
    oSupp.setFTPAddress (txtFTPAddress)
    If Err Then
      Beep
      intPos = txtFTPAddress.SelStart
      txtFTPAddress = oSupp.FTPAddress
      txtFTPAddress.SelStart = intPos - 1
    End If
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSupplier.txtFTPAddress_Change", , EA_NORERAISE
    HandleError
End Sub
Private Sub txtFTPAddress_Validate(Cancel As Boolean)
    On Error GoTo errHandler
    Cancel = Not oSupp.setFTPAddress(txtFTPAddress)
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSupplier.txtFTPAddress_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
