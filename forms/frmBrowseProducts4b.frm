...
Begin VB.Form frmBrowseProducts 
   ...
   EndProperty
   Icon            =   "frmBrowseProducts4b.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   8520
   ScaleWidth      =   14265
   Begin PBKS_Net_ControlsCtl.BookfindGrid BookfindGrid1 
      Height          =   1695
      Left            =   600
      TabIndex        =   2
      Top             =   1320
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   90
      Picture         =   "frmBrowseProducts4b.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   14
      TabStop         =   0   'False
      Top             =   6195
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBrowseProducts4b.frx":07CC
      ...
      TabPicture(1)   =   "frmBrowseProducts4b.frx":07E8
      ...
      TabPicture(2)   =   "frmBrowseProducts4b.frx":0804
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Label6"
      Tab(2).Control(1)=   "cmdGOO"
      Tab(2).Control(2)=   "cboGoogle"
      Tab(2).Control(3)=   "cmdMoreGoo"
      Tab(2).Control(4)=   "chkISBNOnly"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdCourseCodes 
            ...
            Height          =   675
            Left            =   2940
            Picture         =   "frmBrowseProducts4b.frx":0820
            Style           =   1  'Graphical
            TabIndex        =   41
            Top             =   255
            Width           =   945
      ...
      Begin VB.ComboBox cboGoogle 
         ...
         ForeColor       =   &H000000C0&
         Height          =   390
         ItemData        =   "frmBrowseProducts4b.frx":0BAA
         Left            =   -74865
         List            =   "frmBrowseProducts4b.frx":0BAC
         TabIndex        =   29
         Top             =   660
         Width           =   6375
      End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdBIC 
            ...
            Height          =   675
            Left            =   960
            Picture         =   "frmBrowseProducts4b.frx":0BAE
            Style           =   1  'Graphical
            TabIndex        =   23
            Top             =   255
            Width           =   1260
      ...
      Begin VB.Frame frCatalogue 
         ...
         Begin VB.CommandButton cmdCAT 
            ...
            Height          =   705
            Left            =   2070
            Picture         =   "frmBrowseProducts4b.frx":0F38
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   210
            Width           =   975
         ...
         Begin VB.ComboBox cboCat 
            ForeColor       =   &H00800000&
            Height          =   360
            ItemData        =   "frmBrowseProducts4b.frx":12C2
            Left            =   165
            List            =   "frmBrowseProducts4b.frx":12C4
            TabIndex        =   20
            Top             =   390
            Width           =   1410
         End
      ...
      Begin VB.CommandButton cmdsearch 
         ...
         Height          =   810
         Left            =   8025
         Picture         =   "frmBrowseProducts4b.frx":12C6
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   510
         Width           =   1260
      ...
      Begin VB.ComboBox cboSearch 
         ...
         ForeColor       =   &H000000C0&
         Height          =   390
         ItemData        =   "frmBrowseProducts4b.frx":1650
         Left            =   840
         List            =   "frmBrowseProducts4b.frx":1652
         TabIndex        =   0
         Top             =   570
         Width           =   3180
      End
   ...
   Begin TrueOleDBGrid60.TDBGrid GN 
      Height          =   4455
      Left            =   2820
      OleObjectBlob   =   "frmBrowseProducts4b.frx":1654
      TabIndex        =   3
      Top             =   3720
      Width           =   11340
   End
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   10320
      Picture         =   "frmBrowseProducts4b.frx":6957
      Style           =   1  'Graphical
      TabIndex        =   5
      TabStop         =   0   'False
      Top             =   6180
   ...
   Begin TrueOleDBGrid60.TDBGrid GEX 
      Height          =   930
      Left            =   2325
      OleObjectBlob   =   "frmBrowseProducts4b.frx":6CE1
      TabIndex        =   15
      Top             =   3165
      Visible         =   0   'False
      Width           =   11250
   ...
   Begin TrueOleDBGrid60.TDBGrid GOO 
      Height          =   4455
      Left            =   120
      OleObjectBlob   =   "frmBrowseProducts4b.frx":BFE1
      TabIndex        =   31
      Top             =   1725
      Width           =   11340
   End
...
30        SaveLayout Me.GEX, "SearchFormB"
