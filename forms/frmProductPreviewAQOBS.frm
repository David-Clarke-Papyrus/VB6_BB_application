...
Begin VB.Form frmProductPreviewAQ 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProductPreviewAQOBS.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txtOnHand"
      Tab(0).Control(1)=   "txtReserved"
      Tab(0).Control(2)=   "txtPreOwned"
      Tab(0).Control(3)=   "txtRRP"
      Tab(0).Control(4)=   "txtSP"
      Tab(0).Control(5)=   "txtCost"
      Tab(0).Control(6)=   "txtSpecial"
      Tab(0).Control(7)=   "txtUKPrice"
      Tab(0).Control(8)=   "txtUSPrice"
      ...
      Tab(2).Control(6)=   "txtSeriesTitle"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "txtBIC"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "txtBinding"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "cboCategory"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "cboCatHead"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "chkObsolete"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "chkNonStock"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "cmdSetDefault"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "txtVAT"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).ControlCount=   15
      TabCaption(3)   =   "&4. Notes"
      TabPicture(3)   =   "frmProductPreviewAQOBS.frx":0054
      ...
      TabPicture(4)   =   "frmProductPreviewAQOBS.frx":0070
      ...
      Tab(4).Control(4)=   "txtLastDeliveredPrice"
      Tab(4).Control(4).Enabled=   0   'False
      Tab(4).Control(5)=   "txtLastOrderedPrice"
      Tab(4).Control(5).Enabled=   0   'False
      Tab(4).Control(6)=   "txtLastOrderedQty"
      Tab(4).Control(6).Enabled=   0   'False
      Tab(4).Control(7)=   "txtLastDeliveredQty"
      Tab(4).Control(7).Enabled=   0   'False
      Tab(4).Control(8)=   "txtLastOrdered"
      Tab(4).Control(8).Enabled=   0   'False
      Tab(4).Control(9)=   "txtLastDelivered"
      Tab(4).Control(9).Enabled=   0   'False
      Tab(4).Control(10)=   "txtDateLastModified"
      Tab(4).Control(10).Enabled=   0   'False
      Tab(4).Control(11)=   "txtDateAdded"
      Tab(4).Control(11).Enabled=   0   'False
      Tab(4).Control(12)=   "Frame2"
      Tab(4).Control(12).Enabled=   0   'False
      Tab(4).ControlCount=   13
      TabCaption(5)   =   "&6. Wants"
      TabPicture(5)   =   "frmProductPreviewAQOBS.frx":008C
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Height          =   825
      Left            =   8610
      Picture         =   "frmProductPreviewAQOBS.frx":00A8
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   3150
      Width           =   1095
