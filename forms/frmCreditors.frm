...
Begin VB.Form frmCreditors 
   ...
   Begin VB.Frame frLedger 
      ...
      Begin TrueOleDBGrid60.TDBGrid TDBGrid 
         Height          =   3240
         Left            =   0
         OleObjectBlob   =   "frmCreditors.frx":0000
         TabIndex        =   32
         Top             =   0
         Width           =   6855
      End
   ...
   Begin VBControlManager.ControlManager CM 
      ...
      Begin VB.Frame fr1 
         ...
         Begin TrueOleDBGrid60.TDBGrid Grid 
            Height          =   3165
            Left            =   705
            OleObjectBlob   =   "frmCreditors.frx":4C54
            TabIndex        =   29
            Top             =   585
            Width           =   7095
         End
      ...
      Begin VB.Frame fr2 
         ...
         Begin VB.CommandButton cbSince 
            ...
            Width           =   7530
         End
         Begin TrueOleDBGrid60.TDBGrid InvoiceGrid 
            Height          =   3240
            Left            =   720
            OleObjectBlob   =   "frmCreditors.frx":8CC5
            TabIndex        =   4
            Top             =   2115
            Width           =   6855
         End
...
Dim dblBal As Double
    ...
    For i = 1 To InvoiceGrid.Columns.Count
        InvoiceGrid.Columns(i - 1).Width = GetSetting("PBKS", Me.Name & "InvoiceGrid", CStr(i), InvoiceGrid.Columns(i - 1).Width)
    Next
 ...
 '           dblBal = dblBal - oTRs.Item(i).Credit
    ...
    InvoiceGrid.Array = XB
    InvoiceGrid.ReBind
    InvoiceGrid.Caption = oCust.Fullname & " (" & oCust.AcNo & ")"
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
