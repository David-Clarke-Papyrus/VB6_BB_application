...
Begin VB.Form frmProductPreview 
   BackColor       =   &H00E0E0E0&
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProductPreview.frx":0000
      ...
      TabPicture(1)   =   "frmProductPreview.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lvwCopies"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "&3. Details"
      TabPicture(2)   =   "frmProductPreview.frx":0038
      ...
      TabPicture(3)   =   "frmProductPreview.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "txtNote"
      Tab(3).Control(1)=   "txtDescription"
      Tab(3).Control(2)=   "txtSummary"
      Tab(3).Control(3)=   "txtComment"
      Tab(3).Control(4)=   "Label27"
      Tab(3).Control(5)=   "Label28"
      Tab(3).Control(6)=   "Label29"
      Tab(3).Control(7)=   "Label30"
      Tab(3).ControlCount=   8
      TabCaption(4)   =   "&5. Statistics"
      TabPicture(4)   =   "frmProductPreview.frx":0070
      ...
      TabPicture(5)   =   "frmProductPreview.frx":008C
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Height          =   825
      Left            =   8610
      Picture         =   "frmProductPreview.frx":00A8
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   3150
      Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmProductPreview"
