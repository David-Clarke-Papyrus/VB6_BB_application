...
Begin VB.Form frmTPTemplate 
   ...
   Begin TrueOleDBGrid60.TDBGrid GT 
      Height          =   3600
      Left            =   135
      OleObjectBlob   =   "frmTPTemplate.frx":0000
      TabIndex        =   0
      Top             =   135
      Width           =   9315
   End
   ...
   End
End
Attribute VB_Name = "frmTPTemplate"
...
Public Sub component(pXA As XArrayDB, pXB As XArrayDB, pType As String)
    On Error GoTo errHandler
    Set XB = pXB
    Set XA = pXA
    strType = pType
    Me.Caption = "Preview " & IIf(strType = "CUSTOMER", "customers", "suppliers")
    lblCount.Caption = XB.UpperBound(1) & " rows"
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.component(pXA,pXB,pType)", Array(pXA, pXB, pType)
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.cmdExport_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.GT_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmTPTemplate.GetRowType(ColIndex)", ColIndex
End Function
