...
Begin VB.Form frmdelBB 
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboMatch 
         Height          =   315
         Left            =   1920
         OleObjectBlob   =   "frmDELBB1.frx":153C
         TabIndex        =   2
         Top             =   480
         Width           =   7335
      End
      Begin EXCOMBOBOXLibCtl.ComboBox cboProductType 
         Height          =   315
         Left            =   4665
         OleObjectBlob   =   "frmDELBB1.frx":28E6
         TabIndex        =   4
         Top             =   870
         Width           =   2235
      End
   ...
   Begin VB.Image Image1 
      Height          =   255
      Left            =   4380
      Picture         =   "frmDELBB1.frx":401A
      Stretch         =   -1  'True
      Top             =   60
      Width           =   360
   End
End
Attribute VB_Name = "frmdelBB"
...
Dim frm As frmHeader_GRN
    ...
    'for style BB lock selling prices to user input and allow unlock
    bUnlockPrices = Not (oPC.GetProperty("DeliveryStyle") = "BB")
    cmdUnlockPrices.Visible = Not bUnlockPrices
    
    If bUnlockPrices = False Then
...
errHandler:
    ...
    ErrorIn "frmdelBB.component(pCancel,pTPID,pDel)", Array(pCancel, pTPID, pDel)
End Sub
...
If flgLoading Then Exit Sub
    ...
    If oDELL.Product Is Nothing Then Exit Sub
    ...
    oDELL.ForceValidation
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cboProductType_SelectionChanged", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdSection_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim ClaimTRID As Long
    On Error GoTo errHandler
    If oDELL.Product Is Nothing Then Exit Sub
    If oDELL.Product.PID = "" Then Exit Sub
    txtclaim.Enabled = True
    frm.SetParentCoords Me.TOP, Me.Left
    frm.component oDELL.Discount, oDELL.Price(oDel.ISForeignCurrency), oDELL.QtyShort, oDELL.ReasonID, _
        oDELL.CorrectedDiscount, oDELL.CorrectedPrice(oDel.ISForeignCurrency)
    ...
    If Not frm.IsCancelled Then
        ...
        If frm.QtyClaim > 0 Then
            txtclaim = IIf(frm.QtyClaim > 0, "+", "-") & (frm.QtyClaim)
        End If
        If frm.CorrectedDiscount <> oDELL.Discount Then
            oDELL.SetCorrectedDiscount frm.CorrectedDiscount
            txtclaim = txtclaim & IIf(txtclaim > "", ", ", "") & frm.CorrectedDiscountF
        End If
        If frm.CorrectedPrice <> oDELL.Price(oDel.ISForeignCurrency) Then
            oDELL.SetCorrectedPrice frm.CorrectedPrice
            txtclaim = txtclaim & IIf(txtclaim > "", ", ", "") & CStr(frm.CorrectedPrice)
        End If
        txtclaim = "CL:" & txtclaim
        Set oSQL = New z_SQL
        oSQL.CreateSupplierClaim oDel.Supplier.ID, ClaimTRID
        oDELL.ClaimID = ClaimTRID
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdShort_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdSub_Click", , EA_NORERAISE
    HandleError
End Sub

Private Sub cmdUnlockPrices_Click()
    On Error GoTo errHandler
    If SecurityControl(enSECURITY_CUSTDISCOUNT_AUTH, , "Alter prices from received prices.", DOCAPPROVAL) = False Then
           Exit Sub
    End If
    bUnlockPrices = True
    txtSP.Locked = False
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdUnlockPrices_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
Private Sub SetMenu()
    On Error GoTo errHandler
...
Dim tmp As String
    ...
    If cboMatch.Items.SelectCount > 0 Then
        If (cboMatch.Items.CellCaption(cboMatch.Items.SelectedItem(0), 13) <> oDel.Supplier.ID) And bDroppingDown = False And oDel.Supplier.DoNotOrderFrom = False Then
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cboMatch_SelectionChanged", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdBatch_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdCancelMatch_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cbTP_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cbSupp_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdFulfilments_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.LoadNewSupplier(plngTPID)", plngTPID
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdNote_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Terminate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.lvw_Click", , EA_NORERAISE
    HandleError
End Sub

Private Sub lvw_MouseDown(Button As Integer, Shift As Integer, x As Single, Y As Single)
    On Error GoTo errHandler
    If Button = 1 And Shift = 1 Then   ' Check if right mouse button was clicked.
        If Not lvw.SelectedItem Is Nothing Then
            If lvw.SelectedItem.Key > "" Then
                GetMatchingCols (oDel.DeliveryLines(lvw.SelectedItem.Key).PID)
            End If
        End If
    End If
    Exit Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_ValidToSave(pOK)", pOK, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_Valid(pMsg)", pMsg, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDELL_ExtensionChange(lngExtension,strExtension)", Array(lngExtension, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDELL_Valid(msg)", msg, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_TotalChange(strtotal,strTotalForeign,strQtyTotal)", Array(strtotal, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_Reloadlist", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_Dirty(pVal)", pVal, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.oDEL_CurrRowStatus(pMsg)", pMsg, EA_NORERAISE
    HandleError
End Sub



Private Sub oDELL_ValueChanges()
    flgLoading = True
    Me.txtSP = oDELL.PriceSell
    Me.txtMargin = oDELL.MarginF
    flgLoading = False
End Sub
...
Private Sub txtCode_LostFocus()
    On Error GoTo errHandler
    If txtCode > "" Then
        If cboMatch.Items.ItemCount > 1 Then
            bDroppingDown = True
          '    On Error Resume Next
            Sendkeys "+({F4})", True
            bDroppingDown = False
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtCode_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
Private Sub txtMargin_Validate(Cancel As Boolean)
    Cancel = Not oDELL.SetMargin(txtMargin)
    oDELL.ForceValidation
End Sub
...
'    If flgLoading Then Exit Sub
'    oDELL.SetMargin txtMargin
    
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtMargin_Change", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtNote_Change", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtclaim_GotFocus", , EA_NORERAISE
    HandleError
End Sub
Private Sub txtclaim_Validate(Cancel As Boolean)
    On Error GoTo errHandler
    If flgLoading Then Exit Sub
    If Not oDELL.SetQtyShort(txtclaim) Then
        Cancel = True
    End If
   ' oDel.CalculateTotals
   ' txtTotal = oDELL.PLessDiscExtF(oDel.isFOreignCurrency)
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtclaim_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtyFirm_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtySS_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtyFirm_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtySs_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtSP_Change", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtSP_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub

Private Sub txtMargin_GotFocus()
    On Error GoTo errHandler
    txtMargin = oDELL.MarginF
    AutoSelect txtMargin
'    dblCurrentMargin = CalculateMargin()
'    txtMargin = Format(dblCurrentMargin * 100, "###,##0.00")
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtMargin_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.CalculatePrice"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.CalculateMargin"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtSP_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.vCanAdd_NobrokenRules", , EA_NORERAISE
    HandleError
End Sub
...
Dim ar() As String
    ...
    Me.cboMultibuys.Visible = oPC.SupportsMultibuys
'    flgLoading = False
    oDel.GetStatus
    cboProductType.BeginUpdate
    ...
    If oPC.SupportsMultibuys Then
        Me.cboMultibuys.Visible = True
        Me.lblMulti.Visible = True
        LoadCombo Me.cboMultibuys, oPC.Configuration.Multibuys
    Else
        Me.cboMultibuys.Visible = False
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Load", , EA_NORERAISE
    HandleError
End Sub
Public Sub mnuMemo()
    On Error GoTo errHandler
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Initialize", , EA_NORERAISE
    HandleError
End Sub
Private Sub SetFormLayout()
    ...
    If oPC.GetProperty("DeliveryStyle") = "BB" Then
        ...
        lblMulti.TOP = 945
        cboMultibuys.Visible = oPC.SupportsMultibuys
        lblMulti.Visible = oPC.SupportsMultibuys
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.SetFormLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
Dim itm As ListItem
    ...
    If oDELL.Product Is Nothing Then Exit Sub
      If oPC.Configuration.EnforceSections = True Then
          If Not oDELL.Product.ProductSections Is Nothing Then
              If oDELL.Product.ProductSections.Count = 0 Or oDELL.ProductTypeID = oPC.Configuration.DefaultPT Then
                  MsgBox "You must set a product type and category.", vbOKOnly, "Can't post"
                  Exit Sub
              End If
          Else
                  MsgBox "You must set a product type and category.", vbOKOnly, "Can't post"
    ...
    If cboMatch.Items.SelectCount > 0 Then
        ...
        End If
    End If
    If oDELL.QtyFirm + oDELL.QtySS + oDELL.QtyShort <= 0 Then
              MsgBox "You must have a quantity > 0.", vbOKOnly, "Can't post"
              Exit Sub
    End If
    If oPC.GetProperty("AllowZeroCostinGRN") = "FALSE" Then
      If oDELL.Price(oDel.ISForeignCurrency) = 0 Then
              MsgBox "You cannot have a supplier's price of zero.", vbOKOnly, "Can't post"
              Exit Sub
      End If
    End If
    txtclaim.Enabled = False
    If Len(FNS(txtCode)) = 0 Or oDELL.EAN = "" Then
    ...
    '-------------- This is an immediate update of the product type on the product
    If oPC.GetProperty("DeliveryStyle") = "BB" And oDELL.ProductTypeID > 0 Then
        Dim OpenResult As Integer
        OpenResult = oPC.OpenDBSHort
        oPC.COShort.execute "UPDATE tPRODUCT SET P_PRODUCTTYPE_ID = " & CStr(oDELL.ProductTypeID) & " WHERE P_ID = '" & oDELL.PID & "'"
    ...
    If vMode = enAddingRow Then
        If lvw.ListItems.Count < val(oDELL.Key) And val(oDELL.Key) > 0 Then
              If Len(oDELL.EAN) > 9 Then
                  Set itm = lvw.ListItems.Add 'key:=oDELL.key
                  oDELL.RecalculateLine
                  LoadListViewLine itm, oDELL
              Else
                  'oDELL.CancelEdit
                  oDel.DeliveryLines.Remove 1
                  LogSaveToFile "The EAN is blank, row cannot be added. Please contact Papyrus support while leaving this message on the screen. " & oDELL.PID & vbCrLf & oDELL.Title
                  MsgBox "The EAN is blank, row cannot be added. Please contact Papyrus support while leaving this message on the screen.", vbInformation + vbOKOnly, "Warning"
              End If
        End If
        lvw.Refresh
        ChangeState enAddingRow
  ...
  '  cboMatch.BeginUpdate
    ...
    cboMatch.AutoDropDown = False
    ClearLineControls
      txtCode.Locked = False
    oDel.GetStatus
          If tmpPID > "" And oPC.IncludeSupplierFeatures Then
              GetMatchingCols (tmpPID)
          End If
    Exit Sub
errHandler:
  ErrPreserve
  If Err = 35601 Then  'error in line 710 Item not found
      Resume Next
  End If
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdEnter_Click", , EA_NORERAISE
    HandleError
End Sub
Private Sub GetMatchingCols(PID As String)
Dim SQL As String
Dim rs As ADODB.Recordset
Dim f As New frmShowCandidateCustomerOrdersForDeliveryLines

  SQL = "SELECT DISTINCT v.DocumentCode, dbo.tTP.TP_Name AS CustomerName, ba.ADD_L1, ba.ADD_L2, " _
  & " ba.ADD_L3, ba.ADD_L4, ba.ADD_L5, " _
  & " ba.ADD_L6, ba.ADD_Phone AS Phone, ba.ADD_Fax AS Fax, ba.ADD_EMail AS Email, " _
  & " v.COL_Note AS Note, v.COLQtyOrdered AS qtyOrdered, v.COLQtyDispatched AS qtyDispatched, v.DocumentDate, " _
  & "  'Phone: ' + ba.ADD_Phone + '  Fax: ' + ba.ADD_Fax + '  Email: ' + ba.ADD_EMail AS ContactDetails, v.COLQtyOS AS Qty " _
  & " FROM        vCOLFulfilmentCandidates2 v join tTP on v.TR_TP_ID = TP_ID left join vAddresses_Billing ba on ADD_TP_ID = TP_ID " _
  & " WHERE       (TR_Status = 3) AND " _
  & "   (ISNULL(COL_Fulfilled,'OS') = 'OS') AND " _
  & "   (ISNULL(COLQtyOS, 0) > 0) " _
  & "   and PID = '" & PID & "'"
        Dim OpenResult As Integer
        OpenResult = oPC.OpenDBSHort
    Set rs = New ADODB.Recordset
    rs.Open SQL, oPC.COShort, adLockReadOnly
    If Not rs.eof Then
  f.component rs
  f.Show vbModal
    End If
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdNewRows_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.LoadListViewLine(lstItem,oDELL)", Array(lstItem, oDELL)
End Sub
...
'This must load the editing line with the current line's data
    ...
    If oDel.DeliveryLines.Count = 0 Then Exit Sub
    If lvw.SelectedItem.Key = "" Then Exit Sub
    ...
    LoadMatches
    If oPC.SupportsMultibuys Then SetMultibuyCode oDELL.MBCode
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Lvw_DblClick", , EA_NORERAISE, , "error line", Array(Erl())
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.ChangeState(pToMode)", pToMode
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cboTP_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
'-------End Compsny code
'Private Sub txtNote_Change()
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtNote_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtNote_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdListSubstitutions_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim tmp As String
Dim j As Integer
Dim frmMissing As frmMissingTitleAuthor
...
START:
    ...
    If Trim(txtCode) = "" Or vMode = eneditingrow Then
          flgLoading = False
          Exit Function
    End If
    ...
    If txtCode <> oDELL.EAN And txtCode <> oDELL.code Then
      oDELL.SetPrice 0
      oDELL.SetDiscount 0
      oDELL.SetPriceSell 0
      oDELL.SetSection ""
      oDELL.ProductTypeID = oPC.Configuration.DefaultPT
      oDELL.SetQtyFirm 1
      oDELL.SetQtyShort 0
      oDELL.SetQtySS 0
      ClearLineControls
      cboProductType.Items.SelectItem(cboProductType.Items.FindItem(oPC.Configuration.ProductTypes.Item(oPC.Configuration.DefaultPT), 0)) = True
    End If
    bOK = oDELL.SetLineProduct("", txtCode, True)
    Screen.MousePointer = vbDefault
    If bOK Then
        If oDELL.Product.Title = "" Or oDELL.Product.Author = "" Then
            Set frmMissing = New frmMissingTitleAuthor
            frmMissing.component oDELL.Product.PID, oDELL.Product.Title, oDELL.Product.Author
            frmMissing.Show vbModal
            Unload frmMissing
            oDELL.ForceValidation
            GoTo START
        End If
        lblCurrent.Caption = "OH:" & oDELL.Product.QtyOnHandF & "  CO:" & oDELL.Product.QtyOnBackOrderF
        txtSections = oDELL.Product.ProductSections.SectionsAsList
        If Me.cboProductType.Items.ItemCount > 0 Then
            If oDELL.Product.ProductTypeID > 0 Then
                cboProductType.Items.SelectItem(cboProductType.Items.FindItem(oPC.Configuration.ProductTypes.Item(oDELL.Product.ProductTypeID), 0)) = True
        ...
        End If
        CheckForPreviousMatchesInInvoice oDELL.Key
        LoadMatches
        If oPC.SupportsMultibuys Then SetMultibuyCode oDELL.Product.MultibuyCode
        If cboMatch.Items.ItemCount > 0 Then
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.AcceptCode", , , , "Line number,txtCode", Array(Erl(), txtCode)
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtCode_Validate(Cancel)", Cancel, EA_NORERAISE, , "txtCode", Array(txtCode)
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.CheckForPreviousMatchesInInvoice(pKey)", pKey
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.LoadMatches"
End Sub
Private Sub txtDiscount_Validate(Cancel As Boolean)
    On Error GoTo errHandler
    If flgLoading Then Exit Sub
    Cancel = Not IsNumeric(txtDiscount)
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtDiscount_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
Private Sub txtDiscount_GotFocus()
    On Error GoTo errHandler
    txtDiscount = oDELL.Discount
    AutoSelect txtDiscount
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtDiscount_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtPrice_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtPrice_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.PrintDelivery"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdIssue_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdSave_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cmdCancel_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.ClearLineControls"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.lvw_BeforeLabelEdit(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.SetIssueButtonCaption"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Lvw_ColumnClick(ColumnHeader)", ColumnHeader, EA_NORERAISE
    HandleError
End Sub
Private Sub SetLvw()
    On Error GoTo errHandler
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.vCanAdd_Status(errors)", errors, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.SetupcboMatch"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.cboMultibuys_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.SetMultibuyCode(MBCode)", MBCode
End Sub
