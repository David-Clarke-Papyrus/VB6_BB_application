...
'    End If
    ...
    oCNLine.INVLineID = 0
    oCNLine.INVLineCode = ""
    oCNLine.VATRate = oPC.Configuration.VATRate
...
Dim bReturned As Boolean
    ...
    oInv.Load bReturned, pTPID, "", "", , , , pPID, pCode, pPIID, False
