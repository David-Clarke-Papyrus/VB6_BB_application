...
Begin VB.Form frmAPPR 
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboAPPL 
         Height          =   315
         Left            =   1800
         OleObjectBlob   =   "frmApproRet1.frx":0BE8
         TabIndex        =   15
         Top             =   480
         Width           =   6735
      End
