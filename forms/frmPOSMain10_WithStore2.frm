...
Begin VB.Form frmPOSMain 
   ...
   ControlBox      =   0   'False
   FillColor       =   &H00E1E1E1&
   Icon            =   "frmPOSMain10_WithStore2.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9765
   ScaleWidth      =   15240
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   2925
      Left            =   105
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":038A
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   345
      Width           =   12000
   ...
   Begin VB.TextBox txtDiscounts 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   12
      Text            =   "frmPOSMain10_WithStore2.frx":5509
      Top             =   4245
      Visible         =   0   'False
      Width           =   2595
   End
   Begin VB.TextBox txtVouchers 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   11
      Text            =   "frmPOSMain10_WithStore2.frx":550F
      Top             =   4305
      Visible         =   0   'False
      Width           =   2595
   End
   ...
   Begin TrueOleDBGrid60.TDBGrid G4 
      Height          =   2070
      Left            =   1620
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":5515
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   1275
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G2 
      Height          =   1245
      Left            =   60
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":B044
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   3855
      Width           =   4485
   ...
   Begin TrueOleDBGrid60.TDBGrid G5 
      Height          =   2010
      Left            =   1950
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":E6CF
      TabIndex        =   13
      TabStop         =   0   'False
      Top             =   855
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G3 
      Height          =   2400
      Left            =   1500
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":1297A
      TabIndex        =   14
      TabStop         =   0   'False
      Top             =   765
      Visible         =   0   'False
      Width           =   8745
   End
   Begin OposCashDrawer_1_11_LibCtl.OPOSCashDrawer OPOSCashDrawerDigipos 
      Left            =   13680
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":17FC5
      Top             =   5640
   End
   Begin OposPOSPrinter_1_11_LibCtl.OPOSPOSPrinter OPOSPOSPrinterDigipos 
      Left            =   12720
      OleObjectBlob   =   "frmPOSMain10_WithStore2.frx":17FE9
      Top             =   4680
   End
   Begin COPTRLib.OPOSPOSPrinter OPOSPOSPrinter 
      ...
      _StockProps     =   0
   End
   Begin COCASHLib.OPOSCashDrawer OPOSCashDrawer 
      Left            =   11130
      Top             =   6120
      _Version        =   65536
      _ExtentX        =   3863
...
480           End If
490       End If
500     bCanSenseDrawer = Not CheckThisPoint(M_SENSEDRAWEROFF)
    ...
    If fs.FileExists(strFilename) Then
        ...
        Do While Not Src.IsEOF
            ...
            With pPrinter
                ...
                .PrintNormal PTR_S_RECEIPT, ESC + "|N" + ESC + "M1" + strControl + strLine + vbLf
            End With
        Loop
        Src.CloseTextFile
            ...
            If enPrinterType = en_Epson Then
                ...
                If bCanSenseDrawer = True Then
                    If OPOSCashDrawer.CapStatus = True Then
                        ...
                        txtCloseDrawerMessage.ZOrder 0
                        Me.Refresh
'                        OPOSCashDrawer.WaitForDrawerClose 5000, 1000, 100, 1000
'                        txtCloseDrawerMessage.Visible = False
'                        Me.Refresh
                    End If
                End If
