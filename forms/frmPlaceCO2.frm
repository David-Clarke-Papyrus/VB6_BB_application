...
Begin VB.Form frmPlaceCO 
   ...
   Begin EXCOMBOBOXLibCtl.ComboBox cboBC 
      Height          =   315
      Left            =   195
      OleObjectBlob   =   "frmPlaceCO2.frx":0000
      TabIndex        =   24
      Top             =   270
      Width           =   3180
   End
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   1440
      Left            =   150
      OleObjectBlob   =   "frmPlaceCO2.frx":1ABE
      TabIndex        =   22
      Top             =   2955
      Width           =   9390
   End
...
'    On Error Resume Next
'Dim intPos As Integer
'    oCust.setInitials txtInitials
'    If Err Then
'      Beep
'      intPos = txtInitials.SelStart
'      txtInitials = oCust.Initials
'      txtInitials.SelStart = intPos - 1
'    End If
'
'End Sub
