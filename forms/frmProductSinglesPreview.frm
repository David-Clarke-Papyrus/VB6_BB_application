...
Begin VB.Form frmProductSinglePreview 
   ...
   Begin VB.CommandButton cmdForward 
      Height          =   390
      Left            =   4095
      Picture         =   "frmProductSinglesPreview.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   69
      Top             =   5970
      Width           =   435
   ...
   Begin VB.CommandButton cmdBack 
      Height          =   390
      Left            =   3585
      Picture         =   "frmProductSinglesPreview.frx":0694
      Style           =   1  'Graphical
      TabIndex        =   68
      Top             =   5970
      Width           =   435
   ...
   Begin TrueOleDBGrid60.TDBGrid StGrid 
      Height          =   1485
      Left            =   3600
      OleObjectBlob   =   "frmProductSinglesPreview.frx":0A1E
      TabIndex        =   50
      Top             =   6660
      Visible         =   0   'False
      Width           =   1650
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   645
      Left            =   10320
      Picture         =   "frmProductSinglesPreview.frx":4CFD
      Style           =   1  'Graphical
      TabIndex        =   21
      Top             =   5925
      Width           =   1110
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Height          =   645
      Left            =   9210
      Picture         =   "frmProductSinglesPreview.frx":4DA8
      Style           =   1  'Graphical
      TabIndex        =   20
      Top             =   5925
      Width           =   1095
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProductSinglesPreview.frx":50B2
      ...
      Tab(0).Control(21)=   "lblSPDetails"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "MMGRID"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "APPGRID"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "txtOnHand"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "txtReserved"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "txtTotalSold"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtTotalOSAP"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "cmdALLMM"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "DTMMSince"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "txtReturnable"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "cmdRecon"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "txtSSP"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txtCost"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "txtSP"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "txtRRP"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "txtCategorization(0)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "txtCategorization(1)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "txtCategorization(2)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "txtCategorization(3)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "txtCategorization(4)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "txtCategorization(5)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "txtCategorization(6)"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "txtCategorization(7)"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txtDateAdded"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "txtDateLastModified"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "txtLength"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "txtWidth"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).ControlCount=   48
      TabCaption(1)   =   "&2. Details"
      TabPicture(1)   =   "frmProductSinglesPreview.frx":50CE
      ...
      Begin TrueOleDBGrid60.TDBGrid APPGRID 
         Height          =   1245
         Left            =   7110
         OleObjectBlob   =   "frmProductSinglesPreview.frx":50EA
         TabIndex        =   27
         Top             =   435
         Width           =   4065
      End
      Begin TrueOleDBGrid60.TDBGrid MMGRID 
         Height          =   1215
         Left            =   7155
         OleObjectBlob   =   "frmProductSinglesPreview.frx":95F6
         TabIndex        =   28
         Top             =   2250
         Width           =   4035
      End
      Begin VB.Label lblSPDetails 
         ForeColor       =   &H80000011&
         Height          =   285
         Left            =   75
         TabIndex        =   97
...
Dim strPID As String
    If oPC.UniqueProducts Then
        If Forms(0).frmBrowseSingles Is Nothing Then Exit Sub
        strPID = Forms(0).frmBrowseSingles.NextPID
    Else
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmProductSinglePreview: APPGRID_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmProductSinglePreview: APPGRID_DblClick after 5 re-attempts"
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        errRepeat = errRepeat + 1
        LogSaveToFile "Access violation in frmProductSinglePreview: MMGRID_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmProductSinglePreview: MMGRID_DblClick after 5 re-attempts"
            MsgBox "Memory error trying to load product form. Please close any other unnecessary applications before trying again.", vbCritical + vbOKOnly, "Can't load product record."
            Err.Clear
            Exit Sub
        End If
...
Dim oPSEC As a_ProductSection
  ...
  '  Me.txtAgedDate = ""
    ...
    If oProd.SPSetBy > 0 Then
        Me.lblSPDetails.Caption = oPC.Configuration.Staff.FindStaffByID(oProd.SPSetBy).StaffName & IIf(oProd.SPSetDate > "2000-01-01", "(" & oProd.SPSetDateF & ")", "")
    End If
...
'   Me.txtLastCountedPrice = oProd.PriceLastCountedF
 '   Me.txtLastCountedQty = oProd.QtyLastCountedF
    ...
    Me.txtLength = oProd.LengthF
    Me.txtWidth = oProd.WidthF
  ...
  '  LoadProductSections
    For Each oPSEC In oProd.ProductSections
        txtLocation = IIf(txtLocation > "", txtLocation & vbCrLf & oPSEC.Description & "  " & oPSEC.PriorityF, oPSEC.Description & "  " & oPSEC.PriorityF)
    Next
    ...
    If oProd.PID > "" Then
        If fs.FileExists(oPC.SharedFolderRoot & "\Images\" & oProd.BIC) Then
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmProductSinglePreview.LoadPictureFromDB(bytTemp)", bytTemp
End Sub
