...
Begin VB.Form frmCOLAllocationAppros 
   BackColor       =   &H00F8EFEF&
   ...
   Begin VB.CommandButton cmdExcelExport 
      ...
      Height          =   615
      Left            =   5730
      Picture         =   "frmCOLAllocationAppros.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdGenAppros 
         ...
         Height          =   870
         Left            =   450
         Picture         =   "frmCOLAllocationAppros.frx":038A
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   6750
      Picture         =   "frmCOLAllocationAppros.frx":0714
      Style           =   1  'Graphical
      TabIndex        =   12
      ToolTipText     =   "Sets all the allocations to those shown when the form was opened"
      Top             =   5415
   ...
   Begin VB.CommandButton cmdQuit 
      ...
      Height          =   615
      Left            =   7770
      Picture         =   "frmCOLAllocationAppros.frx":0A9E
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Height          =   615
      Left            =   8790
      Picture         =   "frmCOLAllocationAppros.frx":0E28
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid1 
      Height          =   4590
      Left            =   180
      OleObjectBlob   =   "frmCOLAllocationAppros.frx":11B2
      TabIndex        =   0
      Top             =   90
      Width           =   9615
   End
   ...
   End
End
Attribute VB_Name = "frmCOLAllocationAppros"
...
errHandler:
    ...
    ErrorIn "frmCOLAllocationAppros.mnuSaveLayout"
End Sub
Private Sub SetMenu()
    On Error GoTo errHandler
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.SetMenu"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.PrepareNewSlate"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cALLOC_Valid(pResult)", pResult, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.component(pcALLOC,pType,pViewOnly)", Array(pcALLOC, pType, pViewOnly)
End Sub
...
Dim strWSName As String
    ...
    For Each oALLOC In cALLOC
        ...
        XA.Value(lngIndex, 13) = oALLOC.PID
        ...
        End If
        rs.Update
        XA.Value(lngIndex, 1) = oALLOC.ProductOH & "/" & oALLOC.ProductRES & " - " & oALLOC.CodeTitleShort(40)
        XA.Value(lngIndex, 2) = oALLOC.CustomerAcnoName
        AllocFirm = oALLOC.AllocatedQty
        AllocSS = oALLOC.AllocatedQtySS
        AllocateQtys FNN(rs.Fields("BAL")), oALLOC.OrderedQty, oALLOC.DeliveredSoFar, oALLOC.OrderedSSQty, oALLOC.DeliveredSoFarSS, AllocFirm, AllocSS, oALLOC.CustomerBlocked
        oALLOC.AllocatedQty = AllocFirm
        oALLOC.AllocatedQtySS = AllocSS
        If oPC.AllowsSSInvoicing Then
            XA.Value(lngIndex, 3) = oALLOC.OrderedQty & "/" & oALLOC.OrderedSSQty
            XA.Value(lngIndex, 4) = oALLOC.DeliveredSoFar & "/" & oALLOC.DeliveredSoFarSS
            XA.Value(lngIndex, 6) = oALLOC.AllocatedQty & "/" & oALLOC.AllocatedQtySS
        Else
            XA.Value(lngIndex, 3) = oALLOC.OrderedQty
            XA.Value(lngIndex, 4) = oALLOC.DeliveredSoFar
            XA.Value(lngIndex, 6) = oALLOC.AllocatedQty
        End If
        XA.Value(lngIndex, 5) = IIf(strWSName <> oALLOC.WSLock, "**Locked by other workstation:" & oALLOC.WSLock, oALLOC.OrderDetails)
        ...
        Else
            XA.Value(lngIndex, 7) = IIf((FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) > 0, -1, 0)
        End If
        XA.Value(lngIndex, 8) = IIf(oALLOC.UsesSubstitutions = "Y", "Y", "")
        ...
        XA.Value(lngIndex, 15) = IIf(oALLOC.QtyonCO > XA.Value(lngIndex, 3), 1, 0)
        XA.Value(lngIndex, 16) = oALLOC.WSLock
        XA.Value(lngIndex, 20) = oALLOC.CustomerName
        XA.Value(lngIndex, 21) = oALLOC.CustomerBlocked
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.LoadGrid"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.AllocateQtys(Avail,OrdFirm,DelFirm,OrdSS,DelSS,AllocFirm,AllocSS)", _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdReset_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdCheckAll_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdUncheck_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdLoad_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdExcelExport_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdQuit_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim rpt As arCOLSFulfilled
    ...
    If Not cALLOC Is Nothing Then    'And strType = "DELIVERY"
        cALLOC.Save strError, strType, "A"
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.cmdSave_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Form_Initialize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
'    lngDiffH = Grid1.Width - lngDiffH
    ...
    Frame4.Left = NonNegative_Lng(Me.Width - 2600)
    ...
    Frame4.top = Frame4.top + lngDiff
    txtResult.Height = txtResult.Height + lngDiff

    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.optC_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.optCO_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Form_QueryUnload(Cancel,UnloadMode)", Array(Cancel, UnloadMode), _
         EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
Dim strStatus As String
    If Left(XA(Bookmark, 5), 2) = "**" Then
        RowStyle.BackColor = COLOR_CANCELLED
        Exit Sub
    End If
    If InStr(1, XA(Bookmark, 5), "*") > 0 Then
...
'        RowStyle.BackColor = COLOUR_FULFIL_OK
        ...
        Grid1.Columns(2).BackColor = COLOUR_FULFIL_OK
        Grid1.Columns(3).BackColor = COLOUR_FULFIL_OK
        Grid1.Columns(4).BackColor = COLOUR_FULFIL_OK
    ...
    End If
    If XA(Bookmark, 15) <> 0 Then
        RowStyle.Font.Italic = True
        RowStyle.Font.Underline = True
    End If
    If XA(Bookmark, 21) = True Then  'CUstomer is blocked
        RowStyle.BackColor = COLOR_CANCELLED
    End If
    Grid1.Columns(5).BackColor = vbWhite
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
Dim tmp As Long
    ...
    If Left(Grid1.Columns(4).Value, 2) = "**" Then
        Cancel = True
        Exit Sub
    End If
    i = ColIndex + 1
    ...
    Case 6
            ...
            If Grid1.Text > "" Then
                ...
                If bOK = True Then
                    ...
                    If Not rs.eof Then
                        ...
                        rs.Update
                    End If
                    If (FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) > TotalSSFIRM(XA(Grid1.Bookmark, 3), lngFirm, lngSS) - Val(XA(Grid1.Bookmark, 4)) Then
                        MarkRowsValid 4, cALLOC(Val(XA(Grid1.Bookmark, 12))).key    'toomuch
                    ElseIf (FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) > Val(XA(Grid1.Bookmark, 11)) Then
                        MarkRowsValid 3, cALLOC(Val(XA(Grid1.Bookmark, 12))).key    'invalid
                    ElseIf (FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) < TotalSSFIRM(XA(Grid1.Bookmark, 3), lngFirm, lngSS) - Val(XA(Grid1.Bookmark, 4)) Then
                        MarkRowsValid 2, cALLOC(Val(XA(Grid1.Bookmark, 12))).key    'more
                    ElseIf (FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) = TotalSSFIRM(XA(Grid1.Bookmark, 3), lngFirm, lngSS) - Val(XA(Grid1.Bookmark, 4)) Then
                        MarkRowsValid 1, cALLOC(Val(XA(Grid1.Bookmark, 12))).key    'OK
                    End If
                    oALLOC.SetACtionYN (FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) > 0
                    XA.Value(Grid1.Bookmark, 7) = IIf((FNN(oALLOC.AllocatedQty) + FNN(oALLOC.AllocatedQtySS)) > 0, -1, 0)
        ...
        Else
            If ConvertToLng(Grid1.Text, lngResult) Then
                ...
                ElseIf lngResult > Val(XA(Grid1.Bookmark, 11)) Then
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_BeforeColUpdate(ColIndex,OldValue,Cancel)", Array(ColIndex, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.TotalSSFIRM(p,Firm,SS)", Array(p, Firm, SS)
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.SSFIRM_OK(p)", p, EA_NORERAISE
    HandleError
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_AfterColUpdate(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.EnableOK(pOK)", pOK
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.MarkRowsValid(pOK,pKey)", Array(pOK, pKey)
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmCOLAllocationAppros.Grid1_LostFocus", , EA_NORERAISE
    HandleError
End Sub
