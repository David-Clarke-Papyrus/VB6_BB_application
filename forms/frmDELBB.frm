...
Begin VB.Form frmdelBB 
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboMatch 
         Height          =   315
         Left            =   2055
         OleObjectBlob   =   "frmDELBB.frx":153C
         TabIndex        =   52
         Top             =   420
         Width           =   7185
      End
      Begin EXCOMBOBOXLibCtl.ComboBox cboProductType 
         Height          =   390
         Left            =   4605
         OleObjectBlob   =   "frmDELBB.frx":28E6
         TabIndex        =   53
         Top             =   870
         Width           =   2280
      End
...
Private Sub cmdUnlockPrices_Click()
    On Error GoTo errHandler
    If SecurityControl(enSECURITY_ISSUPERVISOR, , "Alter prices from received prices.", DOCAPPROVAL) = False Then
           Exit Sub
    End If
    bUnlockPrices = True
    txtSP.Locked = False
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtyShort_GotFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtQtyShort_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.Lvw_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmdelBB.txtCode_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
