...
Begin VB.Form frmGDNsToInvoice 
   Caption         =   "Un-invoiced Goods delivery notes"
   ClientHeight    =   5895
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15705
   ...
   Begin CCubeX4.ContourCubeX CC 
      ...
      DataSourceType  =   0
      VERSION_NO      =   2
      CCubeXMetadata  =   $"frmGDNsToInvoice.frx":0000
   End
   Begin VB.CommandButton cmdGenInv 
      ...
      Height          =   690
      Left            =   9105
      Picture         =   "frmGDNsToInvoice.frx":206E
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmdQuit 
      ...
      Height          =   615
      Left            =   7950
      Picture         =   "frmGDNsToInvoice.frx":23F8
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":2782
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":2E14
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":34A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":3B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":41CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":485C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":4EEE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":50A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":5252
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":5404
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":55B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":575C
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":5DEE
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":6480
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":6B12
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":71A4
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGDNsToInvoice.frx":753E
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmGDNsToInvoice"
...
Dim Fact As IViewFact
    ...
    If Not rsData.eof Then
        ...
        With CC.Cube
            ...
            .Dims.Add("Customer", "Customer", , xda_vertical).MoveTo xda_vertical
            .Dims.Add("Order code", "CustomerOrderCode", , xda_vertical).MoveTo xda_vertical
            .Dims.Add("GDN", "GDNCode", , xda_vertical).MoveTo xda_vertical
            .Dims.Add("Code", "CodeF", , xda_vertical).MoveTo xda_vertical
            .Dims.Add("Description", "P_Title", , xda_vertical).MoveTo xda_vertical
            If oPC.AllowsSSInvoicing Then
                .BaseFacts.Add "Qty SS Ord", "QtySSOrdered"
                .Facts.Add "Qty", "Qty Del", xfaa_SUM
                .BaseFacts.Add "Qty Firm Ord", "QtyFirmOrdered"
                .Facts.Add "Qty", "Qty Del", xfaa_SUM
                 .BaseFacts.Add "Qty Del SS", "QtySSDispatched"
                .Facts.Add "Qty", "Qty Del Firm", xfaa_SUM
                 .BaseFacts.Add "Qty Del Firm", "QtyFirmDispatched"
                .Facts.Add "Qty", "Qty Del Firm", xfaa_SUM
           Else
                .BaseFacts.Add "Qty Ord", "QtyOrdered"
                .Facts.Add "Qty Ord", "Qty Ord", xfaa_SUM
                .BaseFacts.Add "Qty Del", "QtyDelivered"
                .Facts.Add "Qty Del", "Qty Del", xfaa_SUM
            End If
          ...
          '  CC.HAxis.DrillDownLevel = 1
            CC.VAxis.DrillDownLevel = 4
            CC.TitleSettings.text = "Goods delivery notes to invoice"
...
Dim oIG As New Z_InvoiceGeneration
    ...
    MsgBox "Invoices generated. Form will close", vbOKOnly, "Status"
    Unload Me
...
Dim fs As New FileSystemObject
        ...
        Else
          ...
          If Trim(CommonDialog1.FileName) <> "" Then
                  SaveContourCubeLayout CStr(CommonDialog1.FileName)
          End If
        End If
End Sub
