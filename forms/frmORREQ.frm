...
Dim i As Integer
    ...
    For i = 1 To lvw.ListItems.Count
        dblTotalDeposit = dblTotalDeposit + lvw.ListItems(i).SubItems(3)
    Next
...
Private Sub cmdOK_Click()
    If dblTotalDeposit < oPC.DefaultDeposit_Dec Then
...
Dim f As New frmQuickProductFind
    ...
    If IsNumeric(f.Price) Then
        txtDep1 = IIf(f.Price > 0, f.Price, oPC.DefaultDeposit_DecF)
        dblDeposit = IIf(f.Price > 0, f.Price, oPC.DefaultDeposit_Dec)
