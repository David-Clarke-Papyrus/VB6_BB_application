...
Dim oSFQ As clsServerFQ

Public Sub Component(SFQ As clsServerFQ)
    Set oSFQ = SFQ
    LoadList
End Sub
...
Dim i As Integer
    ...
    With Me.lstClient
        ...
        For i = 0 To oSFQ.ClientListCount
            Set lst = .ListItems.Add
            lst.Text = oSFQ.ClientName(i)
            lst.SubItems(1) = oSFQ.ClientPathName(i)
        Next i
    End With
End Sub
...
Dim i As Integer
    With lstClient
        If MsgBox("Are you sure you want to delete client:" & vbLf & .SelectedItem.Text & _
            ...
            oSFQ.DeleteClient .SelectedItem.Text
            LoadList
        End If
