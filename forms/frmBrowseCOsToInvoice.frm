...
Begin VB.Form frmBrowseCOsToInvoice 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Browse orders to invoice"
   ClientHeight    =   5700
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7185
   ...
   EndProperty
   Icon            =   "frmBrowseCOsToInvoice.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   5700
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   90
      Picture         =   "frmBrowseCOsToInvoice.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   2
      TabStop         =   0   'False
      Top             =   4530
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   5910
      Picture         =   "frmBrowseCOsToInvoice.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   4530
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   4155
      Left            =   75
      OleObjectBlob   =   "frmBrowseCOsToInvoice.frx":0C9E
      TabIndex        =   1
      Top             =   300
      Width           =   6885
   End
End
Attribute VB_Name = "frmBrowseCOsToInvoice"
...
Dim lngCount As Long
        ...
        mcol.LoadOrdersToInvoice bNotFound
