   ...
   Begin VBControlManager.ControlManager CM1 
      ...
      Begin VB.Frame fr2 
         ...
         Begin TrueOleDBGrid60.TDBGrid LedgerGrid 
            Height          =   3240
            Left            =   720
            OleObjectBlob   =   "frmDebtors1.frx":0000
            TabIndex        =   27
            Top             =   2115
            Width           =   6855
         End
      ...
      Begin VB.Frame fr1 
         ...
         Begin TrueOleDBGrid60.TDBGrid Grid 
            Height          =   3165
            Left            =   705
            OleObjectBlob   =   "frmDebtors1.frx":4C57
            TabIndex        =   26
            Top             =   585
            Width           =   7095
         End
...
Private Sub resize()
    ...
    Me.frBalances.Left = fr1.Left + 50
    Me.frBalances.Top = NonNegative_Lng(fr1.Height - 1000)
    frBalances.Height = 900
    Me.cmdMatchPayments.Top = frBalances.Top + 60
