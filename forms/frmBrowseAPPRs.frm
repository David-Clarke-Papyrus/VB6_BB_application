...
Begin VB.Form frmBrowseAPPRs 
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   120
      Picture         =   "frmBrowseAPPRs.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   4500
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   6210
      Picture         =   "frmBrowseAPPRs.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   4470
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind1 
         ...
         Left            =   5220
         MaskColor       =   &H00E0E0E0&
         Picture         =   "frmBrowseAPPRs.frx":0C9E
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
      ...
      Begin VB.TextBox txtArg 
         ...
         Left            =   2670
         TabIndex        =   0
         ToolTipText     =   "Enter product code, document number or Acc no. or start of customer name followed by '*'. Hit ENTER to fetch."
         Top             =   240
         Width           =   2500
      End
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   3345
      Left            =   90
      OleObjectBlob   =   "frmBrowseAPPRs.frx":1028
      TabIndex        =   5
      Top             =   1050
      Width           =   7125
   End
...
errHandler:
    ...
    ErrorIn "frmBrowseAPPRs.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.SetMenu"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cbSince_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cbSince_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cmdFind1_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Grid_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Label3_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.txtArg_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.ArgIsProductCode"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.SetDateArgs"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cmdFind_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.LoadControls"
End Sub
...
Dim i As Integer
    XA.Clear
    XA.ReDim 1, cAPPR.Count, 1, 10
    For i = 1 To cAPPR.Count
        With objItem
            XA.Value(i, 1) = cAPPR(i).CustomerDisplay & (IIf(Len(Trim(cAPPR(i).StaffNameB)) <= 1, "", Trim(cAPPR(i).StaffNameB)))
            XA.Value(i, 10) = cAPPR(i).TPName
            XA.Value(i, 2) = cAPPR(i).DOCCode & cAPPR(i).StaffNameB
            XA.Value(i, 3) = cAPPR(i).DocDateF
            XA.Value(i, 4) = cAPPR(i).DOCDate  'DateForSort
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.LoadArray"
End Sub
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmBrowseAPPRs: Grid_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmBrowseAPPRs: Grid_DblClick after 5 re-attempts"
    ...
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Grid_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Grid_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.Grid_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPRs.IsAmongBookmarks(TRID)", TRID
End Function
...
Dim strExecutable As String
    ...
    With xMLDoc
        ...
        For i = 1 To cAPPR.Count
            If IsAmongBookmarks(cAPPR(i).TRID) Then
            .elCreateSibling "DetailLine", True
            .chCreate "Col_1"
                .elText = cAPPR(i).TPName
            .elCreateSibling "Col_2"
                .elText = cAPPR(i).DOCCode
            .elCreateSibling "Col_3"
                .elText = cAPPR(i).DocDateF
            .elCreateSibling "Col_4"
                .elText = cAPPR(i).StatusF
                .navUP
            End If
        Next i
...
''WRITE THE .RTF FILE
    If Not fs.FileExists(oPC.SharedFolderRoot & "\Templates\APPR_RTF_1.xslt") Then
        MsgBox "You are missing the template file " & "APPR_RTF_1.xslt. Contact Papyrus support." & vbCrLf & "The export is cancelled", vbOKOnly, "Can't do this"
    End If
    objXSL.async = False
    ...
    strFilename = oPC.SharedFolderRoot & "\APPR.RTF"
    i = 0
    Do Until fs.FileExists(strFilename) = False
        i = i + 1
        strFilename = oPC.SharedFolderRoot & "\APPR" & "_" & CStr(i) & ".RTF"
    Loop
