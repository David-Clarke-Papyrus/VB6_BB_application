...
Begin VB.Form frmMarkCustOrdersAsCancelled 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Mark old customer orders as cancelled"
   ClientHeight    =   2775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5505
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   615
      Left            =   3720
      Picture         =   "frmMarkCustOrdersAsCancelled.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   1350
      Width           =   1000
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   615
      Left            =   2700
      Picture         =   "frmMarkCustOrdersAsCancelled.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1350
      Width           =   1000
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BackStyle       =   0  'Transparent
      Caption         =   "Mark customer orders cancelled which are outstanding prior to"
      ForeColor       =   &H00800000&
      Height          =   615
      Left            =   360
      TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmMarkCustOrdersAsCancelled"
...
Private Sub cmdOK_Click()
    ...
    oBatch.MarkCustOrdersAsCancelled dteDate
