...
Begin VB.Form frmBrowseExchanges 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Browse exchanges"
   ClientHeight    =   5700
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8880
   ...
   EndProperty
   Icon            =   "frmBrowseExchanges.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   5700
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   90
      Picture         =   "frmBrowseExchanges.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   4935
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   7725
      Picture         =   "frmBrowseExchanges.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   4965
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind1 
         ...
         Left            =   5310
         MaskColor       =   &H00E0E0E0&
         Picture         =   "frmBrowseExchanges.frx":0C9E
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   3885
      Left            =   120
      OleObjectBlob   =   "frmBrowseExchanges.frx":1028
      TabIndex        =   5
      Top             =   1005
      Width           =   8625
   End
End
Attribute VB_Name = "frmBrowseExchanges"
...
errHandler:
    ...
    ErrorIn "frmBrowseExchanges.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.SetMenu"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cbSince_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cbSince_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cmdFind1_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Grid_BeforeColUpdate(ColIndex,OldValue,Cancel)", Array(ColIndex, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Grid_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.txtArg_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.ArgIsProductCode"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.SetDateArgs"
End Sub
...
Dim lngCount As Long
    ...
    If txtArg > " " And Not (byear) Then
        ...
        Set cPO = Nothing
        Set cPO = New c_POs
        cPO.Load bNotFound, 0, "", txtArg ', dteDate1, dteDate2
        If bNotFound Then
            Set cPO = Nothing
            Set cPO = New c_POs
            SetDateArgs
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Find"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cmdFind_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.LoadControls"
End Sub
...
Dim i As Integer
    ...
    For i = 1 To cPO.Count
        With objItem
            ...
            XA.Value(i, 3) = cPO(i).DocDateF
            XA.Value(i, 4) = cPO(i).Log
            XA.Value(i, 5) = cPO(i).DateForSort
            XA.Value(i, 6) = cPO(i).TRID & "K"
            XA.Value(i, 7) = cPO(i).StatusF
        End With
    Next
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.LoadArray"
End Sub
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmBrowseExchanges: Grid_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmBrowseExchanges: Grid_DblClick after 5 re-attempts"
    ...
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Grid_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Grid_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
Static Direction As Variant
 ...
 '   If ColIndex = 2 Then ColIndex = 4
    If ColIndex = 2 Then
        XA.QuickSort XA.LowerBound(1), XA.UpperBound(1), 5, Direction, GetRowType(5) ', 5, XORDER_DESCEND, XTYPE_STRING 'XTYPE_INTEGER
    Else
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Grid_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.Label3_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.IsAmongBookmarks(TRID)", TRID
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseExchanges.ExportToXML"
End Function
