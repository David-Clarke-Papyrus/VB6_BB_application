...
Begin VB.Form frmBrowseOrders 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboSince 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmBrowseOrders.frx":0000
         Left            =   1200
         List            =   "frmBrowseOrders.frx":0013
         TabIndex        =   8
         Text            =   "Last week"
         Top             =   1110
         Width           =   1890
   ...
   End
End
Attribute VB_Name = "frmBrowseOrders"
