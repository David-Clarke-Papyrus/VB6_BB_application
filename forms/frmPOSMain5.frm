...
Begin VB.Form frmPOSMain 
   ...
   Begin TrueOleDBGrid60.TDBGrid G4 
      Height          =   2040
      Left            =   120
      OleObjectBlob   =   "frmPOSMain5.frx":08D6
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   120
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   2880
      Left            =   135
      OleObjectBlob   =   "frmPOSMain5.frx":6415
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   120
      Width           =   11340
   ...
   Begin TrueOleDBGrid60.TDBGrid G2 
      Height          =   1380
      Left            =   150
      OleObjectBlob   =   "frmPOSMain5.frx":AE5C
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   3705
      Width           =   4245
   ...
   Begin TrueOleDBGrid60.TDBGrid G5 
      Height          =   2010
      Left            =   1950
      OleObjectBlob   =   "frmPOSMain5.frx":E4E7
      TabIndex        =   18
      TabStop         =   0   'False
      Top             =   855
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G3 
      Height          =   2400
      Left            =   1500
      OleObjectBlob   =   "frmPOSMain5.frx":12792
      TabIndex        =   19
      TabStop         =   0   'False
      Top             =   765
      Visible         =   0   'False
...
'??is the following right? what about deposits and invoices
        ...
        Else
            If UCase(txtInput) = "INV" Then
                enRequestState = eInvoice
            End If
...
'    txtPettyCash.Visible = False
    Select Case enPresentState
        ...
        Case eInvoiceno
            ...
            Stat " .. to reverse"
        Case eDepositMode, eInvoiceMode
            G5.Visible = False
            setInputBox "", "", "", False
        ...
        Case ePaymentType_Cash, eDepPaymentType_Cash, eINVPaymentType_Cash
            lblInput.Caption = "Cash received."
            setInputBox CStr(oExchange.BalanceOwing), "", "", True
            Stat "'.. to reverse"
        Case ePaymentType_Cheque, eDEPPaymentType_Cheque, eINVPaymentType_Cheque
            lblInput.Caption = "Cheque value."
            Stat "'.. to reverse"
            setInputBox CStr(oExchange.BalanceOwing), "", "", True
        Case ePaymentType_ChequeRef, eDepPaymentType_ChequeRef, eINVPaymentType_ChequeRef
            setInputBox "", "", "", True
            lblInput.Caption = "Cheque reference."
            Stat "'.. to reverse"
        Case ePaymentType_CreditCard, eDepPaymentType_CreditCard, eINVPaymentType_CreditCard
            lblInput.Caption = "Credit card charge value."
            Stat "'.. to reverse"
            setInputBox CStr(oExchange.BalanceOwing), "", "", True
        Case ePaymentType_CreditNote, eDepPaymentType_CreditNote, eINVPaymentType_CreditNote
            lblInput.Caption = "Credit note value."
            Stat "'.. to reverse"
            setInputBox CStr(oExchange.BalanceOwing), "", "", True
        Case ePaymentType_CreditNoteRef, eDepPaymentType_CreditNoteRef, eINVPaymentType_CreditNoteRef
            setInputBox "", "", "", True
            lblInput.Caption = "Credit note reference."
            Stat "'.. to reverse"
        Case ePaymentType_CreditCardRef, eDepPaymentType_CreditCardRef, eINVPaymentType_CreditCardRef
            setInputBox "", "", "", True
        ...
        Case ePaymentType_RedeemDeposit
            If Len(Trim(txtInput)) > 2 Then
                ...
                End If
            End If
        Case ePaymentType_voucher, eDepPaymentType_voucher, eINVPaymentType_voucher
            lblInput.Caption = "Credit voucher value."
            Stat "'.. to reverse"
            setInputBox CStr(oExchange.BalanceOwing), "", "", True
        Case ePaymentType_voucherRef, eDepPaymentType_voucherRef, eINVPaymentType_voucherRef
            setInputBox "", "", "", True
           ' LoadVoucherTypes
        ...
        Case Else
            If ValidRowNumberSet(txtInput) Then
                ...
                If Not X5 Is Nothing Then
                    If iRow >= X5.LowerBound(1) And iRow <= X5.UpperBound(1) Then
                        lngTmp = X5.Find(1, 1, CStr(iRow), XORDER_ASCEND, XCOMP_EQ, XTYPE_STRING)
                        strDocCode = X5(lngTmp, 2)
                        strPayable = X5(lngTmp, 4)
                        lngINVID = FNN(X5(lngTmp, 5))
                        lngPayable = FNN(X5(lngTmp, 6))
                        lngVAT = FNN(X5(lngTmp, 8))
                        oExchange.TotalVAT = lngVAT
                        strCustomer = X5(lngTmp, 3)
                        oExchange.customer.Load FNN(X5(lngTmp, 7))
                        Set oSALELine = oExchange.SaleLines.Add
                        oSALELine.applyedit
                        oSALELine.beginedit
                        iCurrentSaleLine = iCurrentSaleLine + 1
                        ...
                        oSALELine.PID = ""
                        oSALELine.Qty = 1
                        oSALELine.Price = lngPayable
                        oSALELine.Title = strCustomer
                        oSALELine.code = strDocCode
                        oSALELine.COLID = lngINVID
                        oSALELine.IsDepositItem = True
                        oExchange.CalculateTotals
                        oSALELine.applyedit
                        oSALELine.beginedit
            ...
            If IsNumeric(txtInput) Then
               ...
               ' For i = 0 To UBound(arLineNumber)
                 ...
                 '       lngTotalDeposit = lngTotalDeposit + lngDeposit
                        ...
                        oPAYMENTLine.COLID = lngCOLID
                        oPAYMENTLine.Amt = lngDeposit * -1
                        DisplayPayment
                        
                    Else
                        MsgBox "You cannot refund this deposit as either it has been redeemed or refunded or the deposit value is 0.", vbInformation, "Cannot do this"
                        SetPresentState eProductID
                        Exit Sub
                    End If
             '   Next
...
';;;;
    ...
    Case eInvoiceMode
            ...
            Case ePrevious
                ClearPayments
                SetPresentState eInvoiceno
            Case Else
                Select Case UCase(Trim(txtInput))
                Case "CN"
                    PreparePaymentLine eINVPaymentType_CreditNote
                Case "V"
                    PreparePaymentLine eINVPaymentType_voucher
                Case "Q"
                    PreparePaymentLine eINVPaymentType_Cheque
                Case "CC"
                    PreparePaymentLine eINVPaymentType_CreditCard
                Case "C"
                    PreparePaymentLine eINVPaymentType_Cash
                End Select
                SetMessages
            End Select
    Case eDepositMode
    ...
    Case eProductID
            ...
            Case eInvoice
                FetchInvs
                LoadINVs
                oExchange.SetExchangeType eInvoiceType
                SetPresentState eInvoiceno
            Case ePettyCash
    ...
    Case ePaymentType_Cash
        ...
        Case Else
            If oPAYMENTLine.SetAmt(Trim(txtInput)) Then
'                If oExchange.BalanceOwing <> oPAYMENTLine.Amt Then
'                    MsgBox "You cannot accept a cash amount other than the amount owing", vbInformation, "Warning"
'                    RemovePaymentLine iCurrentPaymentLine
'                    SetPresentState eProductID
'                    Exit Sub
'                End If
...
'[[[[[[[[[[[[[[[[
    ...
    Case eDepPaymentType_voucherRef
        ...
        End Select
']]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
    Case eINVPaymentType_CreditNote
        Select Case pNewState
        Case ePrevious
            RemovePaymentLine iCurrentPaymentLine
            SetPresentState eInvoiceMode
        Case Else
            If oPAYMENTLine.SetAmt(Trim(txtInput)) Then
                oExchange.CalculateTotals
                SetPresentState eINVPaymentType_CreditNoteRef
            Else
                SetTip "Invalid payment amount."
            End If
            DisplayPayment
        End Select
    Case eINVPaymentType_CreditNoteRef
        Select Case pNewState
        Case ePrevious
            SetPresentState eINVPaymentType_CreditNote
        Case Else
            If oPAYMENTLine.setReference(Trim(txtInput)) Then
                oExchange.CalculateTotals
                If oExchange.PaymentsComplete Then
    ...
    Case eINVPaymentType_Cheque
        ...
        Case Else
            If oPAYMENTLine.SetAmt(Trim(txtInput)) Then
                oExchange.CalculateTotals
                SetPresentState eINVPaymentType_ChequeRef
                If oExchange.cashtransaction Then
                    OpenDrawer
                End If
            Else
            ...
            DisplayPayment
        End Select
    Case eINVPaymentType_CreditCard
        Select Case pNewState
        Case ePrevious
            RemovePaymentLine iCurrentPaymentLine
            SetPresentState eInvoiceMode
        Case Else
            If oPAYMENTLine.SetAmt(Trim(txtInput)) Then
                oExchange.CalculateTotals
                SetPresentState eINVPaymentType_CreditCardRef
                If oExchange.cashtransaction Then
                    OpenDrawer
                End If
            Else
    ...
    Case eINVPaymentType_voucher
        ...
        Case Else
            If oPAYMENTLine.SetAmt(Trim(txtInput)) Then
                oExchange.CalculateTotals
                SetPresentState eINVPaymentType_voucherRef
                If oExchange.cashtransaction Then
                    OpenDrawer
                End If
            Else
            ...
            DisplayPayment
        End Select
    Case eINVPaymentType_ChequeRef
        Select Case pNewState
        Case ePrevious
            SetPresentState eINVPaymentType_Cheque
        Case Else
            If oPAYMENTLine.setReference(Trim(txtInput)) Then
                oExchange.CalculateTotals
                If oExchange.PaymentsComplete Then
            ...
            End If
        End Select
    Case eINVPaymentType_CreditCardRef
        Select Case pNewState
        Case ePrevious
            SetPresentState eINVPaymentType_CreditCard
        Case Else
            If oPAYMENTLine.setReference(Trim(txtInput)) Then
                oExchange.CalculateTotals
                If oExchange.PaymentsComplete Then
            ...
            End If
        End Select
    Case eINVPaymentType_voucherRef
        Select Case pNewState
        Case ePrevious
            SetPresentState eINVPaymentType_voucher
        Case Else
            If InStr(1, strValidVoucherTypes, Left(txtInput, 1)) > 0 And Len(txtInput) > 1 Then 'valid voucher type
                If oPAYMENTLine.setReference(Trim(txtInput)) Then
                    oExchange.CalculateTotals
...
'Print Till Slip
    ...
    'If there is a CN being paid out as change - we must print it
        If oExchange.MustPrintCNasChange() Then
            For Each oPayment In oExchange.PaymentLines
                If oPayment.paymentType = "CNR" Then
                    PrintCNasChange oPayment.AmtF, 1, False
                End If
            Next
        End If
    End If
...
End Sub
Private Sub SetForINVSVisible(pYes As Boolean)
    On Error GoTo errHandler
    If pYes Then
        G5.Visible = True
        G5.ZOrder 0
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.PrintCNasChange(pAMtF,pCopyCount,bReprint)", Array(pAmtF, pCopyCount, bReprint)
End Sub
...
Dim oSale As a_Sale
    ...
    Case eInvoiceType
        For Each oSale In oExchange.SaleLines
            ...
            X4.Value(lngSalesItemCount, 5) = ""
            X4.Value(lngSalesItemCount, 6) = "1"
            X4.Value(lngSalesItemCount, 7) = "INVOICE"
            X4.Value(lngSalesItemCount, 8) = oSale.PriceF
            X4.Value(lngSalesItemCount, 9) = oSale.PLessDiscExtF
            X4.Value(lngSalesItemCount, 10) = oExchange.ExchangeID
            X4.Value(lngSalesItemCount, 13) = oExchange.ToVoid
...
strPos = "Pos 1"
  '  sSQL = "SHAPE {SELECT 'E' as TYP,tZSession.* FROM tZSession WHERE (Z_ID = '" & pZID & "')}  AS ZSession APPEND (( SHAPE {SELECT * FROM tOPSESSION WHERE OPS_ID = '" & pOPSID & "'}  AS OPSession APPEND (( SHAPE {SELECT EXCH_STATUS, EXCH_ID, EXCH_ZSESSIONID,EXCH_OPSESSIONID,EXCH_TP_ID,EXCH_TYPE,EXCH_SALEDATE,EXCH_SALEVALUE,EXCH_DISCOUNTVALUE,EXCH_VATVALUE,EXCH_CHANGEGIVEN,EXCH_LOYALTYVALUE,EXCH_TYPE,EXCH_SUPERVISORID,EXCH_NUMBER,EXCH_VOIDS,EXCH_NOTE FROM tEXCHANGE WHERE EXCH_ID = '" & pEXCHID & "'}  AS POSExchange APPEND ({SELECT * FROM tCSL}  AS rsSALESLINES RELATE EXCH_ID TO CSL_EXCH_ID) AS SALESLINES,({SELECT * FROM tPayment}  AS rsPAYMENTS RELATE EXCH_ID TO PAY_EXCH_ID) AS PAYMENTS) AS POSExchange RELATE OPS_ID TO EXCH_OPSESSIONID) AS POSExchange) AS OPSession RELATE Z_ID TO OPS_Z_ID) AS OPSession"
    sSQL = "SHAPE {SELECT 'E' as TYP,tZSession.* FROM tZSession WHERE (Z_ID = '" & pZID & "')}  AS ZSession " _
        ...
        & " APPEND (( SHAPE {SELECT EXCH_STATUS, EXCH_ID, EXCH_ZSESSIONID,EXCH_OPSESSIONID,EXCH_TP_ID,EXCH_TYPE,EXCH_SALEDATE,EXCH_SALEVALUE,EXCH_DISCOUNTVALUE,EXCH_VATVALUE,EXCH_CHANGEGIVEN,EXCH_LOYALTYVALUE,EXCH_TYPE,EXCH_OPERATORID,EXCH_NUMBER,EXCH_VOIDS,EXCH_NOTE " _
...
strPos = "Pos 5" & oPC.StationName
        sFileName = "\" & sFileName & ".pos"
strPos = "Pos 6" & sFileName & "    " & oPS.ClientOutbox
        rsZSession.Save oPS.ClientOutbox & sFileName, adPersistADTG
strPos = "Pos 7" & oPS.ClientOutbox
    End If
    If pEXCHID > "" Then
        SQL = "UPDATE tExchange SET EXCH_STATUS = 'X' WHERE EXCH_ID = '" & pEXCHID & "'"
        oPC.DBLocalConn.Execute SQL
strPos = "Pos 8" & oPC.DBLocalConn.ConnectionString
    End If
    oShapeDB.dbCloseConnectShape
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmPOSMain.SendPOSExchange(pEXCHID,pOPSID,pZID)", Array(pEXCHID, pOPSID, pZID), , , "strPos", Array(strPos)
End Sub
