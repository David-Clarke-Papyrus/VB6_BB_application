...
Begin VB.Form frmTradingPerformance 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmTradingPerformance.frx":0000
      ...
      TabPicture(1)   =   "frmTradingPerformance.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "Tab 2"
      Tab(2).ControlEnabled=   0   'False
      Tab(2).ControlCount=   0
      Begin CCubeX.ContourCubeX CCo 
         Height          =   4845
         Left            =   240
         TabIndex        =   5
         Top             =   780
         ...
         VDrillDownLevel =   1
         Transposed      =   0   'False
         SuppressZeroRows=   -1  'True
         SuppressZeroCols=   -1  'True
         ViewFlags       =   0
         BorderStyle     =   1
         ...
         VERSION_NO      =   2
         FIELDS_SETTINGS =   $"frmTradingPerformance.frx":0038
      End
      Begin CCubeX2.ContourCubeX CC 
         ...
         DataSourceType  =   0
         VERSION_NO      =   2
         CCubeXMetadata  =   $"frmTradingPerformance.frx":00CF
      End
      Begin VB.CommandButton cmdGO_Publisher 
         BackColor       =   &H00C4BCA4&
         Height          =   330
         Left            =   12180
         Picture         =   "frmTradingPerformance.frx":0512
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   375
         Width           =   600
      ...
      Begin VB.ComboBox cboDisplay_Publisher 
         Height          =   315
         ItemData        =   "frmTradingPerformance.frx":089C
         Left            =   8625
         List            =   "frmTradingPerformance.frx":08CD
         Locked          =   -1  'True
         TabIndex        =   7
         Text            =   "Sales"
         Top             =   390
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   615
      Left            =   3480
      Picture         =   "frmTradingPerformance.frx":0A0B
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   75
      Width           =   1000
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   4545
      Picture         =   "frmTradingPerformance.frx":0D95
      Style           =   1  'Graphical
      TabIndex        =   2
      TabStop         =   0   'False
      Top             =   75
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":111F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":17B1
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":1E43
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":24D5
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":2B67
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":31F9
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":388B
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":3A3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":3BEF
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":3DA1
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":3F53
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":40F9
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":478B
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":4E1D
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":54AF
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":5B41
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTradingPerformance.frx":5EDB
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Dim Fact As IViewFact
    ...
    '    CC.AddDimension "PERF_Month", "Mth", xda_horizontal, 1
            If Style = "QtyInTop50" Then
                .BaseFacts.Add "PERF_QtyInTop50", "QtyInTop50"
                .Facts.Add "QtyInTop50", "PERF_QtyInTop50", xfaa_SUM
        ...
        '        CC.CubeTitle = "Returns as percent of sales (calculated at cost values)"
            ElseIf Style = "Margin" Then
                .BaseFacts.Add "Margin", "Margin"
                .Facts.Add "Margin", "Margin", xfaa_SUM
                CC.Facts(0).Appearance.Format = "###,###.00;-###,###.00;###"
                CC.NoGrandTotals = True
                CC.Dims(0).NoTotals = True
                CC.Dims(1).NoTotals = True
        ...
        '        CC.CubeTitle = "Margin percentage"
            ElseIf Style = "Orders placed" Then
                ...
                .Facts.Add "Orders placed", "Margin", xfaa_SUM
                CC.Facts(0).Appearance.Format = "###,###.00;-###,###.00;###"
                CC.NoGrandTotals = True
                CC.Dims(0).NoTotals = True
                CC.Dims(1).NoTotals = True
