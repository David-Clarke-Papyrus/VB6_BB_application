...
Begin VB.Form frmProductPrev 
   ...
   Begin TrueOleDBGrid60.TDBGrid StGrid 
      Height          =   1485
      Left            =   9885
      OleObjectBlob   =   "frmProductPrev.frx":030A
      TabIndex        =   121
      Top             =   60
      Width           =   1650
   End
   ...
   Begin VB.CommandButton cmdDropStock 
      ...
      Height          =   315
      Left            =   11520
      Picture         =   "frmProductPrev.frx":45E9
      Style           =   1  'Graphical
      TabIndex        =   122
      Top             =   1230
      Width           =   270
   ...
   Begin VB.CommandButton cmdBack 
      Height          =   390
      Left            =   3675
      Picture         =   "frmProductPrev.frx":4973
      Style           =   1  'Graphical
      TabIndex        =   114
      Top             =   5505
      Width           =   435
   ...
   Begin VB.CommandButton cmdForward 
      Height          =   390
      Left            =   4185
      Picture         =   "frmProductPrev.frx":4CFD
      Style           =   1  'Graphical
      TabIndex        =   113
      Top             =   5505
      Width           =   435
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   10605
      Picture         =   "frmProductPrev.frx":5087
      Style           =   1  'Graphical
      TabIndex        =   50
      Top             =   5445
      Width           =   1000
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Height          =   615
      Left            =   9585
      Picture         =   "frmProductPrev.frx":5411
      Style           =   1  'Graphical
      TabIndex        =   49
      Top             =   5445
      Width           =   1000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdsearchisbn 
         ...
         Height          =   555
         Left            =   2220
         Picture         =   "frmProductPrev.frx":579B
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   195
         Width           =   1005
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProductPrev.frx":5B25
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "cmdDefaultColWidths"
      Tab(0).Control(1)=   "chkCore"
      Tab(0).Control(2)=   "cmdExplainCost"
      Tab(0).Control(3)=   "txtWeight"
      Tab(0).Control(4)=   "cmdStatusChange"
      Tab(0).Control(5)=   "txtSP"
      Tab(0).Control(6)=   "cmdDropAppros"
      Tab(0).Control(7)=   "cmdDropMovements"
      Tab(0).Control(8)=   "cmdDropCO"
      Tab(0).Control(9)=   "cmdDropPO"
      Tab(0).Control(10)=   "txtEUPrice"
      Tab(0).Control(11)=   "cmdRecon"
      Tab(0).Control(12)=   "txtSSP"
      Tab(0).Control(13)=   "txtReturnable"
      Tab(0).Control(14)=   "DTMMSince"
      Tab(0).Control(15)=   "cmdALLMM"
      Tab(0).Control(16)=   "txtTotalOSAP"
      Tab(0).Control(17)=   "txtTotalOSCO"
      Tab(0).Control(18)=   "txtTotalOSPO"
      Tab(0).Control(19)=   "txtUSPrice"
      Tab(0).Control(20)=   "txtUKPrice"
      Tab(0).Control(21)=   "txtTotalSold"
      Tab(0).Control(22)=   "txtCost"
      Tab(0).Control(23)=   "txtRRP"
      Tab(0).Control(24)=   "txtReserved"
      Tab(0).Control(25)=   "txtOnHand"
      Tab(0).Control(26)=   "POGrid"
      Tab(0).Control(27)=   "COGrid"
      Tab(0).Control(28)=   "APPGRID"
      Tab(0).Control(29)=   "MMGRID"
      Tab(0).Control(30)=   "Label3"
      Tab(0).Control(31)=   "lblNDA"
      Tab(0).Control(32)=   "Label29"
      Tab(0).Control(33)=   "Label40"
      Tab(0).Control(34)=   "lblStatus"
      Tab(0).Control(35)=   "Label32"
      Tab(0).Control(36)=   "Label31"
      Tab(0).Control(37)=   "Label21"
      Tab(0).Control(38)=   "Label19"
      Tab(0).Control(39)=   "Label16"
      Tab(0).Control(40)=   "Label14"
      Tab(0).Control(41)=   "Label13"
      Tab(0).Control(42)=   "Label18"
      Tab(0).ControlCount=   43
      TabCaption(1)   =   "&2. Details"
      TabPicture(1)   =   "frmProductPrev.frx":5B41
      ...
      TabPicture(2)   =   "frmProductPrev.frx":5B5D
      ...
      Tab(2).Control(6)=   "txtDescription"
      Tab(2).Control(7)=   "txtComment"
      Tab(2).Control(8)=   "txtFlagText"
      Tab(2).Control(9)=   "txtCategoryHeading"
      Tab(2).Control(10)=   "txtCatalogues"
      Tab(2).Control(11)=   "txtNotes"
      Tab(2).ControlCount=   12
      TabCaption(3)   =   "&4. Statistics"
      TabPicture(3)   =   "frmProductPrev.frx":5B79
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Label12"
      Tab(3).Control(1)=   "Label22"
      Tab(3).Control(2)=   "Label1"
      Tab(3).Control(3)=   "Label36"
      Tab(3).Control(4)=   "Label37"
      Tab(3).Control(5)=   "Label38"
      Tab(3).Control(6)=   "Shape1"
      Tab(3).Control(7)=   "Label45"
      Tab(3).Control(8)=   "Frame2"
      Tab(3).Control(9)=   "txtDateAdded"
      Tab(3).Control(10)=   "txtDateLastModified"
      Tab(3).Control(11)=   "txtLastCounted"
      Tab(3).Control(12)=   "txtLastCountedQty"
      Tab(3).Control(13)=   "txtLastCountedPrice"
      Tab(3).ControlCount=   14
      TabCaption(4)   =   "&5. Substitute products"
      TabPicture(4)   =   "frmProductPrev.frx":5B95
      ...
      TabPicture(5)   =   "frmProductPrev.frx":5BB1
      ...
      Begin VB.CommandButton cmdDefaultColWidths 
         ...
         Height          =   315
         Left            =   -67935
         Picture         =   "frmProductPrev.frx":5BCD
         Style           =   1  'Graphical
         TabIndex        =   147
      ...
      Begin VB.CommandButton cmdDropAppros 
         ...
         Height          =   315
         Left            =   -63870
         Picture         =   "frmProductPrev.frx":5F57
         Style           =   1  'Graphical
         TabIndex        =   120
         Top             =   1320
         Width           =   225
      ...
      Begin VB.CommandButton cmdDropMovements 
         ...
         Height          =   315
         Left            =   -63870
         Picture         =   "frmProductPrev.frx":62E1
         Style           =   1  'Graphical
         TabIndex        =   119
         Top             =   3135
         Width           =   225
      ...
      Begin VB.CommandButton cmdDropCO 
         ...
         Height          =   315
         Left            =   -67905
         Picture         =   "frmProductPrev.frx":666B
         Style           =   1  'Graphical
         TabIndex        =   118
         Top             =   3150
         Width           =   225
      ...
      Begin VB.CommandButton cmdDropPO 
         ...
         Height          =   315
         Left            =   -67890
         Picture         =   "frmProductPrev.frx":69F5
         Style           =   1  'Graphical
         TabIndex        =   117
         Top             =   1320
         Width           =   225
      ...
      Begin TrueOleDBGrid60.TDBGrid POGrid 
         Height          =   1230
         Left            =   -71910
         OleObjectBlob   =   "frmProductPrev.frx":6D7F
         TabIndex        =   51
         Top             =   420
         Width           =   4020
      End
      Begin TrueOleDBGrid60.TDBGrid COGrid 
         Height          =   1335
         Left            =   -71910
         OleObjectBlob   =   "frmProductPrev.frx":B76E
         TabIndex        =   62
         Top             =   2145
         Width           =   4005
      End
      Begin TrueOleDBGrid60.TDBGrid APPGRID 
         Height          =   1215
         Left            =   -67605
         OleObjectBlob   =   "frmProductPrev.frx":FC79
         TabIndex        =   64
         Top             =   435
         Width           =   3720
      End
      Begin TrueOleDBGrid60.TDBGrid MMGRID 
         Height          =   1335
         Left            =   -67605
         OleObjectBlob   =   "frmProductPrev.frx":14185
         TabIndex        =   69
         Top             =   2130
         Width           =   3735
      End
      Begin TrueOleDBGrid60.TDBGrid GSB 
         Height          =   1320
         Left            =   -73410
         OleObjectBlob   =   "frmProductPrev.frx":182CC
         TabIndex        =   105
         Top             =   2550
         Width           =   9495
      End
      Begin TrueOleDBGrid60.TDBGrid GSF 
         Height          =   1500
         Left            =   -73410
         OleObjectBlob   =   "frmProductPrev.frx":1C338
         TabIndex        =   106
         Top             =   960
         Width           =   9495
      End
      Begin TrueOleDBGrid60.TDBGrid Grid1 
         Height          =   2790
         Left            =   -74790
         OleObjectBlob   =   "frmProductPrev.frx":204D4
         TabIndex        =   109
         Top             =   660
         Width           =   10965
      End
