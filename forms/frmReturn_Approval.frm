...
Begin VB.Form frmReturn_approval 
   BackColor       =   &H00D3D3CB&
   ...
   Begin VB.CommandButton cmdclose 
      ...
      Left            =   7800
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmReturn_Approval.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmdreprint 
      ...
      Height          =   615
      Left            =   1500
      Picture         =   "frmReturn_Approval.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   5310
      Width           =   2295
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   75
      Picture         =   "frmReturn_Approval.frx":0714
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   5295
      Width           =   1320
   ...
   Begin VB.CommandButton cmdIssue 
      ...
      Height          =   615
      Left            =   8850
      Picture         =   "frmReturn_Approval.frx":0A9E
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   5280
      Width           =   2175
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid1 
      Height          =   4530
      Left            =   210
      OleObjectBlob   =   "frmReturn_Approval.frx":0E28
      TabIndex        =   0
      Top             =   600
      Width           =   10860
   End
   ...
   End
End
Attribute VB_Name = "frmReturn_approval"
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.component(pR,pSUpplierName)", Array(pR, pSupplierName)
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.SetMenu"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.mnuCancel"
End Sub
Public Sub mnuVoid()
    On Error GoTo errHandler
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.mnuVoid"
End Sub
...
Dim i As Integer
    ...
    Do While lngIndex <= cRL.Count
            ...
            If dR.RType = "E" Then
                XA.Value(lngIndex, 2) = cRL(lngIndex).ProductDescription
                XA.Value(lngIndex, 3) = cRL(lngIndex).code
            Else
                XA.Value(lngIndex, 2) = cRL(lngIndex).ProductDescription
                XA.Value(lngIndex, 3) = cRL(lngIndex).SupplierInvoiceRef & ":" & cRL(lngIndex).SupplierInvoiceDateF
            End If
            ...
            XA.Value(lngIndex, 14) = cRL(lngIndex).EAN
   ...
   ' XA.QuickSort 1, lngArrayRows, 11, XORDER_ASCEND, XTYPE_STRING, 2, XORDER_ASCEND, XTYPE_STRING
    XA.QuickSort 1, lngArrayRows, 2, XORDER_ASCEND, XTYPE_STRING
    Grid1.Array = XA
    Grid1.ReBind
'errHandler:
'    If ErrMustStop Then Debug.Assert False: Resume
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.LoadGridNew"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdCancel_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdIssue_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim oReport As New arReturns1
    ...
    rs.fields.Append "SuppInvDate", adVarChar, 50
    rs.open
    For i = 1 To lngArrayRows
        rs.AddNew
            rs.fields("RLID") = XA.Value(i, 9)
            ...
            rs.fields("SuppInvDate") = FNS(XA.Value(i, 13))
        rs.Update
    Next
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.PrintRequest"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdreprint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_AfterColUpdate(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmReturn_approval: Grid1_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmReturn_approval: Grid1_DblClick after 5 re-attempts"
    ...
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_FetchCellStyle(Condition,Split,Bookmark,Col,CellStyle)", _
         Array(Condition, Split, Bookmark, col, CellStyle), EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
         RowStyle), EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_BeforeColUpdate(ColIndex,OldValue,Cancel)", Array(ColIndex, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.ValidateRow(pOKAtPresent)", pOKAtPresent
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.cmdFixMissingInvoiceRefs_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim str As String
    If IsNull(Grid1.Bookmark) Then Exit Sub
    str = IIf(FNS(XA.Value(Grid1.Bookmark, 14)) > "", FNS(XA.Value(Grid1.Bookmark, 14)), "")
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Grid1_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim idx As Long
    If Len(Text1) = 13 Then
        idx = XA.Find(1, 14, Text1, XORDER_ASCEND, XCOMP_EQ, XTYPE_STRING)
    End If
    MsgBox CStr(idx)
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmReturn_approval.Text1_Change", , EA_NORERAISE
    HandleError
End Sub
