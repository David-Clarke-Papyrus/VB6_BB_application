...
Begin VB.Form frmBrowseQuotations 
   ...
   EndProperty
   Icon            =   "frmBrowseQuotations.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   5700
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   60
      Picture         =   "frmBrowseQuotations.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   5040
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Left            =   7725
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmBrowseQuotations.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   5040
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind1 
         ...
         Left            =   5220
         MaskColor       =   &H00E0E0E0&
         Picture         =   "frmBrowseQuotations.frx":0C9E
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   3705
      Left            =   105
      OleObjectBlob   =   "frmBrowseQuotations.frx":1028
      TabIndex        =   5
      Top             =   1275
      Width           =   8655
   End
...
Dim ofrm As frmQuotationPreview
...
errHandler:
    ...
    ErrorIn "frmBrowseQuotations.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.SetMenu"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.cbSince_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.cmdFind1_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Grid_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.txtArg_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.ArgIsProductCode"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.SetDateArgs"
End Sub
...
Dim lngCount As Long
    ...
    If txtArg > " " And Not (byear) Then
        ...
        If bNotFound Then
            ...
            Set cInv = New c_QU
            SetDateArgs
            cInv.Load bNotFound, 0, txtArg, "", dteDate1, dteDate2
            If bNotFound Then
                ...
                If lngTPID > 0 Then
                    ...
                    Set cInv = New c_QU
                    SetDateArgs
                    cInv.Load bNotFound, lngTPID, "", "", dteDate1, dteDate2
                End If
            End If
        Else
            enSince = 1
    ...
    Else
        ...
        Else
            SetDateArgs
        End If
        cInv.Load bNotFound, 0, "", "", dteDate1, dteDate2
    End If
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Find", , , , "txtArg", Array(txtArg)
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.cmdFind_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Label3_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.LoadControls"
End Sub
...
Dim i As Integer
    XA.Clear
    XA.ReDim 1, cInv.Count, 1, 10
    For i = 1 To cInv.Count
        With objItem
            XA.Value(i, 1) = cInv.Item(i).CustomerDisplay & (IIf(Len(Trim(cInv.Item(i).StaffNameB)) <= 1, "", "(" & Trim(cInv.Item(i).StaffNameB) & ")"))
           ' XA.Value(i, 1) = cInv.Item(i).TPNAME & (IIf(Len(Trim(cInv.Item(i).TPACCNo)) <= 1, "", "(" & Trim(cInv.Item(i).TPACCNo) & ")")) & (IIf(Len(Trim(cInv.Item(i).SMSHortname)) <= 1, "", "(" & Trim(cInv.Item(i).SMSHortname) & ")"))
            XA.Value(i, 2) = cInv.Item(i).Ref & cInv.Item(i).StaffNameB
            XA.Value(i, 3) = cInv.Item(i).TDateF
            XA.Value(i, 4) = cInv.Item(i).Log
            XA.Value(i, 5) = cInv.Item(i).TRID & "K"
            XA.Value(i, 6) = cInv.Item(i).StatusF
          '  XA.Value(i, 7) = cInv.Item(i).proforma
            XA.Value(i, 8) = cInv.Item(i).DateForSort
            XA.Value(i, 10) = cInv.Item(i).TPName
        End With
    Next
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.LoadArray"
End Sub
...
Dim blnEdit As Boolean
    ...
    Screen.MousePointer = vbHourglass
    Set ofrm = New frmQuotationPreview
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Grid_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Grid_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
Static Direction As Variant
 ...
 '   If ColIndex = 2 Then ColIndex = 4
    ...
    ElseIf ColIndex = 2 Then
        XA.QuickSort XA.LowerBound(1), XA.UpperBound(1), 4, Direction, GetRowType(4)
    Else
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.Grid_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.IsAmongBookmarks(TRID)", TRID
End Function
...
Dim strExecutable As String
    ...
    With xMLDoc
        ...
        For i = 1 To cInv.Count
            If IsAmongBookmarks(cInv.Item(i).TRID) Then
            .elCreateSibling "DetailLine", True
            .chCreate "Col_1"
                .elText = cInv.Item(i).TPName & (IIf(Len(Trim(cInv(i).TPAccNo)) <= 1, "", "(" & Trim(cInv(i).TPAccNo) & ")")) & (IIf(Len(Trim(cInv(i).SMSHortname)) <= 1, "", "(" & Trim(cInv(i).SMSHortname) & ")"))
            .elCreateSibling "Col_2"
                .elText = cInv.Item(i).Ref
            .elCreateSibling "Col_3"
                .elText = cInv.Item(i).TDateF
            .elCreateSibling "Col_4"
                .elText = cInv.Item(i).StatusF
                .navUP
            End If
        Next i
...
''WRITE THE .RTF FILE
    ...
    strFilename = oPC.SharedFolderRoot & "\INV.RTF"
    i = 0
    Do Until fs.FileExists(strFilename) = False
        i = i + 1
        strFilename = oPC.SharedFolderRoot & "\INV" & "_" & CStr(i) & ".RTF"
    Loop
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseQuotations.ExportToXML"
End Function
