...
Begin VB.Form frmBrowseCOSR 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Browse customer order status reports"
   ClientHeight    =   5700
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8850
   ...
   Begin VB.CommandButton cmdGenerate 
      BackColor       =   &H00C4BCA4&
      Caption         =   "&Generate new reports"
      Height          =   1170
      Left            =   7035
      Picture         =   "frmBrowseCOSR.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   9
      TabStop         =   0   'False
      Top             =   60
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   75
      Picture         =   "frmBrowseCOSR.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   5040
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Left            =   7725
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmBrowseCOSR.frx":0C9E
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   5040
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind1 
         ...
         Left            =   5220
         MaskColor       =   &H00E0E0E0&
         Picture         =   "frmBrowseCOSR.frx":1028
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   3705
      Left            =   105
      OleObjectBlob   =   "frmBrowseCOSR.frx":13B2
      TabIndex        =   5
      Top             =   1275
      Width           =   8655
   End
End
Attribute VB_Name = "frmBrowseCOSR"
...
Dim ofrm As frmCustomerOrderStatusReport
...
errHandler:
    ...
    ErrorIn "frmBrowseCOSR.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cbSince_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cmdFind1_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim oSQL As New z_SQL
    ...
    If MsgBox("You are going to generate new reports for customers receiving EDI order reports.", vbInformation + vbOKCancel, "Confirm") = vbCancel Then
        Exit Sub
    End If
    oSQL.RunProc "GenerateCOSR", Array(), ""
    cmdFind1_Click
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cmdGenerate_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Grid_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.txtArg_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.ArgIsProductCode"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.SetDateArgs"
End Sub
...
Dim lngCount As Long
    ...
    If txtArg > " " And Not (byear) Then
        If ArgIsProductCode Then
            ...
            Set cCOSR = Nothing
            Set cCOSR = New c_COSR
            cCOSR.Load bNotFound, 0, "", "", , , , txtArg
            GoTo EXIT_Handler
        End If
        ...
        If bNotFound Then
            ...
            Set cCOSR = New c_COSR
            SetDateArgs
            cCOSR.Load bNotFound, 0, txtArg, "", dteDate1, dteDate2
            If bNotFound Then
               ...
               If lngTPID > 0 Then
                    ...
                    Set cCOSR = New c_COSR
                    SetDateArgs
                    cCOSR.Load bNotFound, lngTPID, "", "", dteDate1, dteDate2
                '    txtArg = ""
               End If
            End If
        Else
    ...
    Else
        ...
        Else
            SetDateArgs
        End If
        cCOSR.Load bNotFound, 0, "", "", dteDate1, dteDate2
    End If
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cmdFind_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Label3_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.LoadControls"
End Sub

Private Sub LoadArray()
    On Error GoTo errHandler
Dim objItem As d_COSR
Dim itmList As ListItem
Dim lngIndex As Long
Dim i As Integer
    XA.Clear
    XA.ReDim 1, cCOSR.Count, 1, 10
    For i = 1 To cCOSR.Count
        With objItem
            XA.Value(i, 1) = cCOSR.Item(i).CustomerDisplay & (IIf(Len(Trim(cCOSR.Item(i).StaffNameB)) <= 1, "", "(" & Trim(cCOSR.Item(i).StaffNameB) & ")"))
           ' XA.Value(i, 1) = cCOSR.Item(i).TPNAME & (IIf(Len(Trim(cCOSR.Item(i).TPACCNo)) <= 1, "", "(" & Trim(cCOSR.Item(i).TPACCNo) & ")")) & (IIf(Len(Trim(cCOSR.Item(i).SMSHortname)) <= 1, "", "(" & Trim(cCOSR.Item(i).SMSHortname) & ")"))
            XA.Value(i, 2) = cCOSR.Item(i).Ref & cCOSR.Item(i).StaffNameB
            XA.Value(i, 3) = cCOSR.Item(i).TDateF
            XA.Value(i, 4) = cCOSR.Item(i).Log
            XA.Value(i, 5) = cCOSR.Item(i).TRID & "K"
            XA.Value(i, 6) = cCOSR.Item(i).StatusF
          '  XA.Value(i, 7) = cCOSR.Item(i).proforma
            XA.Value(i, 8) = cCOSR.Item(i).DateForSort
            XA.Value(i, 10) = cCOSR.Item(i).TPName
        End With
    Next
    XA.QuickSort 1, XA.UpperBound(1), 8, XORDER_DESCEND, XTYPE_STRING
    Grid.Array = XA
    Exit Sub
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.LoadArray"
End Sub
...
Dim blnEdit As Boolean
    ...
    Screen.MousePointer = vbHourglass
    Set ofrm = New frmCustomerOrderStatusReport
    lngID = val(XA(Grid.Bookmark, 5))
    ofrm.component lngID, "Customer order status report for:" & XA(Grid.Bookmark, 1) & " (" & XA(Grid.Bookmark, 2) & ")"
    ofrm.Show
    Screen.MousePointer = vbDefault
    Exit Sub
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmBrowseCOSR: Grid_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmBrowseCOSR: Grid_DblClick after 5 re-attempts"
    ...
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Grid_DblClick", , EA_NORERAISE
    HandleError
End Sub
Private Sub Grid_FetchRowStyle(ByVal Split As Integer, Bookmark As Variant, ByVal RowStyle As TrueOleDBGrid60.StyleDisp)
    ...
    If oPC.AllowsInvoicePicking Then
        ...
        End If
    Else
        If XA(Bookmark, 6) = "COMPLETE" Or XA(Bookmark, 6) = "ISSUED" Then
            RowStyle.BackColor = &HFFFFC0
        End If
    End If
    If XA(Bookmark, 7) = True Then    'Proforma
        If XA(Bookmark, 6) = "COMPLETE" Then
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Grid_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.Grid_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.IsAmongBookmarks(TRID)", TRID
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseCOSR.ExportToXML"
End Function
