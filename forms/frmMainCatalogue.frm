...
Option Explicit
Dim WithEvents oCat As z_Catalog
...
Dim fs As New Scripting.FileSystemObject
    ...
    If Not fs.FolderExists(oPC.SharedFolderRoot & "\Catalogues") Then
        fs.CreateFolder oPC.SharedFolderRoot & "\Catalogues"
    End If
    CD1.InitDir = oPC.SharedFolderRoot & "\Catalogues"
