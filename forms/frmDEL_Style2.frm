...
Begin VB.Form frmdel_Style2 
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Left            =   8730
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmDEL_Style2.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   29
      TabStop         =   0   'False
      Top             =   5460
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Left            =   7710
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmDEL_Style2.frx":2B2C
      Style           =   1  'Graphical
      TabIndex        =   17
      TabStop         =   0   'False
      Top             =   5460
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboProductType 
         Height          =   315
         Left            =   4575
         OleObjectBlob   =   "frmDEL_Style2.frx":2EB6
         TabIndex        =   53
         Top             =   870
         Width           =   2400
      End
      Begin EXCOMBOBOXLibCtl.ComboBox cboMatch 
         Height          =   315
         Left            =   2055
         OleObjectBlob   =   "frmDEL_Style2.frx":4260
         TabIndex        =   52
         Top             =   435
         Width           =   7185
      End
      ...
      Begin VB.CommandButton cmdShort 
         ...
         Height          =   345
         Left            =   1785
         Picture         =   "frmDEL_Style2.frx":560A
         Style           =   1  'Graphical
         TabIndex        =   47
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdEnter 
         ...
         Left            =   9615
         MaskColor       =   &H00C4BCA4&
         Picture         =   "frmDEL_Style2.frx":5994
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   1470
         Width           =   1000
   ...
   Begin VB.CommandButton cmdIssue 
      ...
      Height          =   615
      Left            =   9750
      Picture         =   "frmDEL_Style2.frx":5D1E
      Style           =   1  'Graphical
      TabIndex        =   16
      TabStop         =   0   'False
      Top             =   5460
   ...
   Begin VB.Image Image1 
      Height          =   255
      Left            =   4380
      Picture         =   "frmDEL_Style2.frx":60A8
      Stretch         =   -1  'True
      Top             =   60
      Width           =   360
   End
