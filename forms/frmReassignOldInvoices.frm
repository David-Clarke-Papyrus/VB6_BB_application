...
Begin VB.Form frmReAssignOldInvoices 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Reassign old invoices"
   ClientHeight    =   2775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5505
   ...
   Begin VB.CheckBox chkCust 
      ...
      BackColor       =   &H00D3D3CB&
      Caption         =   "Delete customers for these invoices also"
      ForeColor       =   &H8000000D&
      Height          =   300
      Left            =   810
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   615
      Left            =   4305
      Picture         =   "frmReassignOldInvoices.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   1485
      Width           =   1000
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   615
      Left            =   3285
      Picture         =   "frmReassignOldInvoices.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1485
      Width           =   1000
   ...
   Begin VB.Label Label3 
      ...
      Caption         =   $"frmReassignOldInvoices.frx":0714
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label1 
      ...
      BackColor       =   &H00E0E0E0&
      BackStyle       =   0  'Transparent
      Caption         =   "Reassign invoices dated prior to"
      ForeColor       =   &H8000000D&
      Height          =   615
      Left            =   360
      TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmReAssignOldInvoices"
...
Dim QtyDocsDeleted As Long
Dim QtyCustomerDeleted As Long
    Set oBatch = New z_Batch
    Screen.MousePointer = vbHourglass
    oBatch.TransferOldinvoicesToCasual dteDate, chkCust, QtyDocsDeleted, QtyCustomerDeleted
    Screen.MousePointer = vbDefault
    MsgBox CStr(QtyDocsDeleted) & " quotations deleted. " & CStr(QtyCustomerDeleted) & " customers deleted. ", vbInformation, "Status"
    Me.Hide
End Sub
