...
Begin VB.Form frmTopSales_dlg 
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   3000
      Picture         =   "frmTopSales_dlg.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   14
      TabStop         =   0   'False
      Top             =   2940
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   615
      Left            =   4020
      Picture         =   "frmTopSales_dlg.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   2940
      Width           =   1000
   ...
   Begin EXCOMBOBOXLibCtl.ComboBox cboProductType 
      Height          =   390
      Left            =   1710
      OleObjectBlob   =   "frmTopSales_dlg.frx":0714
      TabIndex        =   5
      Top             =   1620
      Width           =   3255
   End
   ...
   End
End
Attribute VB_Name = "frmTopSales_dlg"
...
Public Sub Component(pHeading As String)
    Me.Caption = pHeading
End Sub
