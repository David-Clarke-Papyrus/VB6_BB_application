...
Begin VB.Form frmBrowseProducts 
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   90
      Picture         =   "frmBrowseProducts2.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   20
      TabStop         =   0   'False
      Top             =   6195
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBrowseProducts2.frx":07CC
      ...
      TabPicture(1)   =   "frmBrowseProducts2.frx":07E8
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame2"
      Tab(1).Control(1)=   "frCatalogue"
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdBIC 
            ...
            Height          =   675
            Left            =   1365
            Picture         =   "frmBrowseProducts2.frx":0804
            Style           =   1  'Graphical
            TabIndex        =   29
            Top             =   300
            Width           =   1260
      ...
      Begin VB.Frame frCatalogue 
         ...
         Begin VB.CommandButton cmdCAT 
            ...
            Height          =   705
            Left            =   2235
            Picture         =   "frmBrowseProducts2.frx":0B8E
            Style           =   1  'Graphical
            TabIndex        =   27
            Top             =   210
            Width           =   1260
         ...
         Begin VB.ComboBox cboCat 
            ForeColor       =   &H00800000&
            Height          =   360
            ItemData        =   "frmBrowseProducts2.frx":0F18
            Left            =   165
            List            =   "frmBrowseProducts2.frx":0F1A
            TabIndex        =   26
            Top             =   390
            Width           =   1410
         End
      ...
      Begin VB.CommandButton cmdsearch 
         ...
         Height          =   810
         Left            =   8025
         Picture         =   "frmBrowseProducts2.frx":0F1C
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   510
         Width           =   1260
      ...
      Begin VB.ComboBox cboSearch 
         ...
         ForeColor       =   &H000000C0&
         Height          =   390
         ItemData        =   "frmBrowseProducts2.frx":12A6
         Left            =   840
         List            =   "frmBrowseProducts2.frx":12A8
         TabIndex        =   0
         Top             =   570
         Width           =   3180
      End
   ...
   Begin TrueOleDBGrid60.TDBGrid GN 
      Height          =   4455
      Left            =   105
      OleObjectBlob   =   "frmBrowseProducts2.frx":12AA
      TabIndex        =   3
      Top             =   1695
      Width           =   11340
   End
   Begin TrueOleDBGrid60.TDBGrid GBF 
      Height          =   4455
      Left            =   105
      OleObjectBlob   =   "frmBrowseProducts2.frx":648D
      TabIndex        =   6
      Top             =   1695
      Width           =   11265
   End
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   10320
      Picture         =   "frmBrowseProducts2.frx":B071
      Style           =   1  'Graphical
      TabIndex        =   5
      TabStop         =   0   'False
      Top             =   6180
   ...
   Begin TrueOleDBGrid60.TDBGrid GEX 
      Height          =   930
      Left            =   945
      OleObjectBlob   =   "frmBrowseProducts2.frx":B3FB
      TabIndex        =   21
      Top             =   4365
      Visible         =   0   'False
      Width           =   11250
...
Dim i As Long
    ...
    Case enLocalDB
        ...
        For i = 1 To colList.Count
                ...
                XN.Value(i, 5) = colList.Item(i).QtyOnHand & " / " & colList.Item(i).QtyOnOrder & " / " & colList.Item(i).QtyOnBackorder
...
'        str = Replace(FNS(cboSearch), "/", "")
'       ' OpenBrowser "http://books.google.com/books?q=" & str
'    strURL = "http://books.google.com/books?q=greek&btnG=Search+Books"
'    'check for at least 11 characters ("http://www.")
'    Me.Text1.Text = Inet1.OpenURL(strURL, icString)
'
'End Sub
