...
Begin VB.Form frmInvoicePreview 
   ...
   Icon            =   "frmInvoicewSSPreviewDisp.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6210
   ScaleWidth      =   11400
   ...
   Begin VB.CommandButton cmdclose 
      ...
      Left            =   1950
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmInvoicewSSPreviewDisp.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Left            =   1080
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmInvoicewSSPreviewDisp.frx":2B2C
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Left            =   210
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmInvoicewSSPreviewDisp.frx":2EB6
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   1350
      Left            =   240
      OleObjectBlob   =   "frmInvoicewSSPreviewDisp.frx":3240
      TabIndex        =   18
      Top             =   1905
      Width           =   10725
   End
   ...
   Begin TrueOleDBGrid60.TDBGrid GD 
      Height          =   1350
      Left            =   240
      OleObjectBlob   =   "frmInvoicewSSPreviewDisp.frx":865B
      TabIndex        =   26
      Top             =   3330
      Visible         =   0   'False
      Width           =   10725
