...
Begin VB.Form frmInvoice 
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboRef 
         Height          =   345
         Left            =   165
         OleObjectBlob   =   "frmInvoice4.frx":30B6
         TabIndex        =   1
         Top             =   1170
         Visible         =   0   'False
         Width           =   5160
...
'This must load the editing line with the current line's data
    ...
    If Me.cboRef.Items.ItemCount > 0 And oInvLine.COLID > 0 Then
        ...
        oInvLine.Qty = cboRef.Items.CellCaption(cboRef.Items.SelectedItem(0), 2)
        oInvLine.COLID = cboRef.Items.CellCaption(cboRef.Items.SelectedItem(0), 3)
        oInvLine.Ref = cboRef.Items.CellCaption(cboRef.Items.SelectedItem(0), 0)
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInvoice.SaveInvoice", , , , "strErrPos", Array(strErrPos)
End Sub
