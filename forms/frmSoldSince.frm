...
Begin VB.Form frmSoldSince 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Books sold since"
   ClientHeight    =   5085
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6330
   ...
   End
End
Attribute VB_Name = "frmSoldSince"
...
errHandler:
    ...
    ErrorIn "frmSoldSince.cboOperators_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.cmdCancel_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.cmdFile_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim oEx As a_Export
    ...
    strOpDesc = "Exporting items sold since " & Me.txtSince & vbCrLf & "formatted for " & strOPTo & vbCrLf & "and saving the data in " & strFilename
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.cmdOK_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.OptABE_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.OptBiblio_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmSoldSince.txtSince_Validate(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
