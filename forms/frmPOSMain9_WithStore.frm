...
Begin VB.Form frmPOSMain 
   ...
   ControlBox      =   0   'False
   FillColor       =   &H00E1E1E1&
   Icon            =   "frmPOSMain9_WithStore.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9765
   ScaleWidth      =   16545
   ...
   Begin TrueOleDBGrid60.TDBGrid G1 
      Height          =   2925
      Left            =   105
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":038A
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   345
      Width           =   12000
   ...
   Begin VB.TextBox txtDiscounts 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   12
      Text            =   "frmPOSMain9_WithStore.frx":5415
      Top             =   4245
      Visible         =   0   'False
      Width           =   2595
   End
   Begin VB.TextBox txtVouchers 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   11
      Text            =   "frmPOSMain9_WithStore.frx":541B
      Top             =   4305
      Visible         =   0   'False
      Width           =   2595
   End
   ...
   Begin TrueOleDBGrid60.TDBGrid G4 
      Height          =   2070
      Left            =   1620
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":5421
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   1275
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G2 
      Height          =   1245
      Left            =   60
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":AE30
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   3855
      Width           =   4485
   ...
   Begin TrueOleDBGrid60.TDBGrid G5 
      Height          =   2010
      Left            =   1950
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":E4A3
      TabIndex        =   13
      TabStop         =   0   'False
      Top             =   855
      Visible         =   0   'False
   ...
   Begin TrueOleDBGrid60.TDBGrid G3 
      Height          =   2400
      Left            =   1500
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":1270A
      TabIndex        =   14
      TabStop         =   0   'False
      Top             =   765
      Visible         =   0   'False
      Width           =   8745
   End
   Begin OposPOSPrinter_1_5_LibCtl.OPOSPOSPrinter OPOSPOSPrinterPosiflex 
      Left            =   11205
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":17C61
      Top             =   6600
   End
   Begin OposCashDrawer_1_5_LibCtl.OPOSCashDrawer OPOSCashDrawerPosiflex 
      Left            =   11145
      OleObjectBlob   =   "frmPOSMain9_WithStore.frx":17C85
      Top             =   6225
   End
...
Const M_SENSEDRAWEROFF As Long = 32768
...
290           oPC.InitializeSettings
300           oPC.dbConnect
310           oPC.LoadProperties
320           oPC.loadRoundingRules
330           oPC.loadMultibuys
340           If oPC.ServerIPAddress <> oPC.NameOfPC Then
350               SynchronizeTOD oPC.ServerIPAddress
360           End If
370       End If
380     bCanSenseDrawer = Not CheckThisPoint(M_SENSEDRAWEROFF)

390         If oPC.GetLoyaltyCode = "" Then
400             oPC.dbConnectMain
410             Set rst = New ADODB.Recordset
420             rst.Open "SELECT CF_BC_ID,CF_LOYALTYCLUBTYPE FROM tCONFIGURATION", oPC.DBMainConn
430             strSQL = "UPDATE tAPPSETTINGS SET BC_Code = '" & FNS(rst.Fields(0)) & "',Loyalty_Code = '" & FNS(rst.Fields(1)) & "'"
440            oPC.OpenLocalDatabase
450            oPC.DBLocalConn.Execute strSQL
460             rst.Close
470         End If
480       bCollectRepcode = oPC.GetProperty("CollectRepCodeTF")
          
          
          
490       bLoggedOnAlready = False
500       bLogonOK = True
510       oPC.SetupZSession lngStaffID, strName
520       If oPC.ZSession.SupervisorID = 0 Then
530           If oPC.GetProperty("CaptureFloat") = "TRUE" Then
540               bGetFloat = True
550           Else
560               bGetFloat = False
570           End If
580           LogonOperator bGetFloat, dblFLoat, sFloatBreakdown
590           If bLogonOK = False Then
600               bCloseZsession = True
610               GoTo EXITHANDLER
620           End If
630           oPC.ZSession.SupervisorID = lngStaffID
640           oPC.ZSession.SupervisorName = strName
650           bLoggedOnAlready = True
660       End If
670       strPos = "4"
680       If oPC.ZSession.LoadOpenXSession = False Then
690           oPC.ZSession.OpSession.Start_OP_Session oPC.ZSession.Current_Z_Session_ID, lngStaffID
700           If oPC.ZSession.OpSession.SupervisorID = 0 Then
710               If bLoggedOnAlready = False Then
720                   If oPC.GetProperty("CaptureFloat") = "TRUE" Then
730                       bGetFloat = True
740                   Else
750                       bGetFloat = False
760                   End If
770                   LogonOperator bGetFloat, dblFLoat, sFloatBreakdown
780                   If bLogonOK = False Then
790                       bCloseXsession = True
800                       bCloseZsession = True
810                       GoTo EXITHANDLER
820                   End If
830               End If
840               oPC.OpenLocalDatabase
850               oPC.ZSession.OpSession.SetOperatorID lngStaffID, dblFLoat, sFloatBreakdown
                 ' oPC.ZSession.OpSession.OperatorID = lngStaffID
860               oPC.ZSession.OpSession.Name = strName
870               oPC.CloseLocalDatabase
880           End If
890       End If
900       strPos = "5"
910       SetForCOLSVisible False
920       If oPC.UseCashDrawer Then
930           If oPC.DriveDrawer = True Then  'There is a COM connected Cash Drawer
940               MSComm1.Settings = oPC.COMPORTSettings
950               MSComm1.CommPort = oPC.CashDrawerPort
960               If MSComm1.PortOpen = False Then
970                   MSComm1.PortOpen = True
980               End If
990           Else                            'There is a cash drawer connected to the Printer
...
1010      End If
1020      strPos = "6"
1030      If oPC.PrintSlips Then
1040          If oPC.UseA4Printer = False Then
1050             SetupPrinter
1060          Else
1070              Printer.FontName = "COURIER"
1080              Printer.FontSize = 12
1090              iColWidth = 50
1100          End If
1110      End If
1120      If Not bEnvironmentOK Then
1130          GoTo EXITHANDLER
1140      End If
1150      LoadVoucherTypes
1160      LoadDiscountTypes
1170      txtInput.BackColor = RGB(230, 250, 210)
          
1180      G1.Array = X1
1190      G4.Height = 380
1200      If oPC.DatabaseName <> "PBKSFD_TEST" Then
1210          ReSendExchanges
1220      End If
1230      strPos = "8"
1240      X4.Clear
1250      X4.ReDim 1, 0, 1, 13
1260      LoadExchanges
1270      SetupQueues
          
1280      Set qTimer = New XTimer
1290      qTimer.Interval = 10000
1300      qTimer.Enabled = True
          
1310      If oPC.DatabaseName = "PBKSFD_TEST" Then
1320          Me.BackColor = vbRed
1330      End If
1340      Me.ScaleMode = vbTwips
1350      SetGridLayout G1, Me.Name & "A"
1360      SetGridLayout G4, Me.Name & "B"
1370      SetFormSize Me
...
1390      Exit Sub
errHandler:
1400      If ErrMustStop Then Debug.Assert False: Resume
1410      ErrorIn "frmPOSMain.Form_Load"
End Sub
...
Dim lngResult As Long
    ...
    ElseIf UCase(oPC.GetProperty("ReceiptPrinterType")) = "POSIFLEX" Then
        enPrinterType = en_DPosiflex
    End If
    If oPC.PrintSlips = True Then
        If enPrinterType = en_Epson Then
            Set OPOSPrinter = OPOSPOSPrinter1
        ...
        Else
            If oPC.UseCashDrawer Then
                lngResult = OPOSCashDrawerPosiflex.Open(oPC.TillDrawerName)
                If lngResult = 0 Then
                    lngResult = OPOSCashDrawerPosiflex.ClaimDevice(1000)
                    If lngResult = 0 Then
                ...
                End If
            End If
            Set OPOSPrinter = OPOSPOSPrinterPosiflex
            With OPOSPOSPrinterPosiflex
                bIgnorestatus = True
                lngResult = OPOSPOSPrinterPosiflex.Open(oPC.Printername)
                If lngResult = 0 Then
                    lngResult = OPOSPOSPrinterPosiflex.ClaimDevice(50)
                    If lngResult = OPOS_SUCCESS Then
                        OPOSPOSPrinterPosiflex.DeviceEnabled = True
                        OPOSPOSPrinterPosiflex.MapMode = PTR_MM_METRIC
                        OPOSPOSPrinterPosiflex.RecLetterQuality = True
                        OPOSPOSPrinterPosiflex.RecLineChars = 40
...
Dim LastNumber As Long
    ...
    If enPrinterType = en_Epson Then
        If Not Me.OPOSPOSPrinter1 Is Nothing Then
            With OPOSPOSPrinter1
                .DeviceEnabled = False
                .ReleaseDevice
                .Close
        ...
        End If
    Else
        If Not Me.OPOSPOSPrinterPosiflex Is Nothing Then
            With OPOSPOSPrinterPosiflex
                .DeviceEnabled = False
                .ReleaseDevice
                .Close
...
290               X4.Value(lngSalesItemCount, 7) = FNS(rs.Fields("TITLE")) & IIf(FNN(rs.Fields("EXCH_Voids")) > 0, " (Voids:" & FNN(rs.Fields("EXCH_Voids")) & ")", "")
...
On Error GoTo errHandler
    ...
    If bCanSenseDrawer = True Then
        If enPrinterType = en_Epson Then
            If OPOSCashDrawer1.DrawerOpened = True Then
...
Dim i As Integer
    ...
    Else
        If bCanSenseDrawer = True Then
            If enPrinterType = en_Epson Then
                If OPOSCashDrawer1.DrawerOpened = False Then
                    bDrawerFlag = True
                ...
                End If
            Else
                If OPOSCashDrawerPosiflex.DrawerOpened = False Then
                    bDrawerFlag = True
                    OPOSCashDrawerPosiflex.OpenDrawer
                    txtCloseDrawerMessage.Visible = True
                    txtCloseDrawerMessage.ZOrder 0
                End If
            End If
...
End Sub
Private Sub OPOSCashDrawerPosiflex_StatusUpdateEvent(ByVal Data As Long)
    If bCanSenseDrawer = False Then Exit Sub
    If bIgnorestatus Then Exit Sub   '-THis is to handle a strange problem Posiflex printer statuses are coming thru here
    If OPOSCashDrawerPosiflex.DrawerOpened = False Then
        bDrawerFlag = False
        txtCloseDrawerMessage.Visible = False
    Else
