...
Begin VB.Form frmSupplierPreview 
   ...
   ClientWidth     =   10440
   ControlBox      =   0   'False
   Icon            =   "frmSupplierPreview1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   5160
   ...
   Begin VB.CommandButton cmdEdit 
      ...
      Height          =   615
      Left            =   8070
      Picture         =   "frmSupplierPreview1.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   32
      Top             =   4095
      Width           =   1000
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   9090
      Picture         =   "frmSupplierPreview1.frx":0714
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   4095
      Width           =   1000
   ...
   Begin VB.CommandButton cmdDelete 
      ...
      Height          =   615
      Left            =   7065
      Picture         =   "frmSupplierPreview1.frx":0A9E
      Style           =   1  'Graphical
      TabIndex        =   30
      Top             =   4095
      Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmSupplierPreview1.frx":0E28
      ...
      TabPicture(1)   =   "frmSupplierPreview1.frx":0E44
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lvwAddresses"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "&3. Terms"
      TabPicture(2)   =   "frmSupplierPreview1.frx":0E60
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "chkClaimNeedsApproval"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "txtSettlementTermsType"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "txtSettlementTerms"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "txtSettlementDiscount"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "txtTermsType"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "txtTerms"
      ...
      TabPicture(3)   =   "frmSupplierPreview1.frx":0E7C
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "txtFTPAddress"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "cmdRecalc"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "txtCurrencyConversionRate"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "txtEDIType"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "txtParent"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "txtEDINumber"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "txtReturnStartMonths"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "txtReturnEndMonths"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "chkVATable"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "chkActive"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "txtDefaultDeliverydays"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "txtRecordLastChanged"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "txtRecordAdded"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "Label15"
      Tab(3).Control(13).Enabled=   0   'False
      Tab(3).Control(14)=   "lblCurrencyConversionRate"
      Tab(3).Control(14).Enabled=   0   'False
      Tab(3).Control(15)=   "Label13"
      Tab(3).Control(15).Enabled=   0   'False
      Tab(3).Control(16)=   "lblInactive"
      Tab(3).Control(16).Enabled=   0   'False
      Tab(3).Control(17)=   "lblPaysVAT"
      Tab(3).Control(17).Enabled=   0   'False
      Tab(3).Control(18)=   "lblWeReceiveFrom"
      Tab(3).Control(18).Enabled=   0   'False
      Tab(3).Control(19)=   "Label12"
      Tab(3).Control(19).Enabled=   0   'False
      Tab(3).Control(20)=   "Label11"
      Tab(3).Control(20).Enabled=   0   'False
      Tab(3).Control(21)=   "Label6"
      Tab(3).Control(21).Enabled=   0   'False
      Tab(3).Control(22)=   "Label7"
      Tab(3).Control(22).Enabled=   0   'False
      Tab(3).Control(23)=   "Label9"
      Tab(3).Control(23).Enabled=   0   'False
      Tab(3).Control(24)=   "Label4"
      Tab(3).Control(24).Enabled=   0   'False
      Tab(3).Control(25)=   "Label5"
      Tab(3).Control(25).Enabled=   0   'False
      Tab(3).Control(26)=   "Label8"
      Tab(3).Control(26).Enabled=   0   'False
      Tab(3).ControlCount=   27
      TabCaption(4)   =   "Note"
      TabPicture(4)   =   "frmSupplierPreview1.frx":0E98
      Tab(4).ControlEnabled=   -1  'True
      Tab(4).Control(0)=   "txtNote"
      Tab(4).Control(0).Enabled=   0   'False
      Tab(4).ControlCount=   1
      Begin VB.CheckBox chkClaimNeedsApproval 
         Alignment       =   1  'Right Justify
         Caption         =   "Claim needs approval"
         Enabled         =   0   'False
         ForeColor       =   &H8000000D&
         Height          =   330
         Left            =   -73530
         ...
         Width           =   2010
      End
      Begin VB.TextBox txtSettlementTermsType 
         Appearance      =   0  'Flat
         BackColor       =   &H00DBFAFB&
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
         ...
         Width           =   1335
      End
      Begin VB.TextBox txtSettlementTerms 
         Appearance      =   0  'Flat
         BackColor       =   &H00DBFAFB&
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
...
Private Sub Form_Load()
  ...
  '  chkActive = IIf(oSupp.UseStatus = 0, 0, 1)
    ...
    End If
    chkClaimNeedsApproval = IIf(oSupp.ClaimNeedsApproval = True, 1, 0)
    txtTerms = oSupp.TermsF
    txtTermsType = oSupp.TermsTypeF
    txtSettlementDiscount = oSupp.SettlementDiscountF
    txtSettlementTerms = oSupp.SettlementTerms
    txtSettlementTermsType = oSupp.SettlementTermsTypeF
