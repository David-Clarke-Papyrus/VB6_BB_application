...
Begin VB.Form frmBrowseCNBackup 
   BackColor       =   &H00E0E0E0&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboSince 
         Height          =   345
         ItemData        =   "frmBrowseCNBackup.frx":0000
         Left            =   1200
         List            =   "frmBrowseCNBackup.frx":0013
         TabIndex        =   8
         Text            =   "Last week"
         Top             =   1020
         Width           =   1890
   ...
   End
End
Attribute VB_Name = "frmBrowseCNBackup"
    ...
    For i = 1 To mcol.Count
        ...
        With objItm
           ...
           ' .SubItems(1) = mcol(i).TPName
            .SubItems(1) = mcol(i).InvoiceNumber
            .SubItems(2) = Format(mcol(i).CODate, "Short Date")
