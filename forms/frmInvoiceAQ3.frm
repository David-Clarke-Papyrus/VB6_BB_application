...
Begin VB.Form frmInvoice 
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Left            =   8550
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmInvoiceAQ3.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   22
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Left            =   7440
      MaskColor       =   &H00C4BCA4&
      Picture         =   "frmInvoiceAQ3.frx":2B2C
      Style           =   1  'Graphical
      TabIndex        =   10
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboRef 
         Height          =   345
         Left            =   165
         OleObjectBlob   =   "frmInvoiceAQ3.frx":30B6
         TabIndex        =   1
         Top             =   1170
         Visible         =   0   'False
         Width           =   5160
   ...
   Begin VB.CommandButton cmdIssue 
      ...
      Height          =   765
      Left            =   9675
      Picture         =   "frmInvoiceAQ3.frx":4460
      Style           =   1  'Graphical
      TabIndex        =   9
      TabStop         =   0   'False
      Top             =   5355
   ...
   Begin VB.Image Image1 
      Height          =   255
      Left            =   3465
      Picture         =   "frmInvoiceAQ3.frx":45AA
      Stretch         =   -1  'True
      Top             =   615
      Width           =   360
   End
...
Dim i As Integer
    ...
    If vMode = enAddingRow Then
        LogSaveToFile "Invoice line added:" & oInvLine.Key
...
strPos = "Pos 2"
    ...
    With oProd
        ...
        If oProd.pID > "" Then
            lngResult = oSQL.RunGetRecordset("SELECT TR_CODE,TR_DATE FROM tTR JOIN tINVOICE ON TR_ID = I_ID JOIN tILINE ON IL_TR_ID = TR_ID WHERE IL_P_ID = '" & oProd.pID & "' AND TR_TP_ID = " & oInvoice.Customer.ID, enText, Array(), "", rsPreviousBillings, True)
...
strPos = "Pos 3"
                        ...
                        Loop
                        If strPreviousBillings > "" Then
                            MsgBox "This item has been previously sold to this client." & vbCrLf & strPreviousBillings, vbInformation, "Warning"
                        End If
                    End If
                End If
            End If
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInvoice.txtCode_Validate(Cancel)", Cancel, EA_NORERAISE, , "strPOS", Array(strPos)
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInvoice.LoadandSHowcboRef(pID)", pID
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmInvoice.cboRef_LostFocus"
End Sub
