...
Begin VB.Form frmAPP 
   ...
   Begin VB.Frame fr1 
      ...
      Begin EXCOMBOBOXLibCtl.ComboBox cboMatch 
         Height          =   315
         Left            =   1680
         OleObjectBlob   =   "frmAppro.frx":0A5E
         TabIndex        =   4
         Top             =   480
         Width           =   3945
      End
...
Dim currPrice As Currency
    With oCNLine
        ...
        lstItem.SubItems(6) = .ExtensionInclDepositF
    End With
End Sub
