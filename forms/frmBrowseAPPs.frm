...
Begin VB.Form frmBrowseAPPs 
   BackColor       =   &H00D3D3CB&
   Caption         =   "Browse appros"
   ClientHeight    =   5700
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7005
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   615
      Left            =   90
      Picture         =   "frmBrowseAPPs.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   4710
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   615
      Left            =   5760
      Picture         =   "frmBrowseAPPs.frx":0914
      Style           =   1  'Graphical
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   4710
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdFind1 
         ...
         Left            =   5220
         MaskColor       =   &H00E0E0E0&
         Picture         =   "frmBrowseAPPs.frx":0C9E
         Style           =   1  'Graphical
         TabIndex        =   5
         TabStop         =   0   'False
      ...
      Begin VB.TextBox txtArg 
         ...
         Left            =   2610
         TabIndex        =   0
         ToolTipText     =   "Enter product code, document number, Acc no. or start of customer name followed by '*'. Hit ENTER to fetch."
         Top             =   240
         Width           =   2500
      End
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid 
      Height          =   3345
      Left            =   60
      OleObjectBlob   =   "frmBrowseAPPs.frx":1028
      TabIndex        =   1
      Top             =   1245
      Width           =   6705
   End
End
Attribute VB_Name = "frmBrowseAPPs"
...
errHandler:
    ...
    ErrorIn "frmBrowseAPPs.mnuSaveLayout"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cbSince_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cbSince_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cmdClose_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cmdFind1_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Form_Activate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Form_Deactivate", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Form_Resize", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Grid_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Label3_Click", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.txtArg_KeyPress(KeyAscii)", KeyAscii, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.ArgIsProductCode"
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.SetDateArgs"
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.IsAmongBookmarks(TRID)", TRID
End Function
...
Dim lngCount As Long
    ...
    If txtArg > " " And Not (byear) Then
        If ArgIsProductCode Then
            ...
            Set cAPP = Nothing
            Set cAPP = New c_APPs
            cAPP.Load bNotFound, 0, "", "", dteDate1, dteDate2, , txtArg
            GoTo EXIT_Handler
        End If
        If txtArg = "\" Then
            ...
            Set cAPP = Nothing
            Set cAPP = New c_APPs
            cAPP.Load bNotFound, 0, "", "", , , , , , True
            GoTo EXIT_Handler
        End If
        'Search for Reference
        Set cAPP = Nothing
        Set cAPP = New c_APPs
        If Left(txtArg, 1) = "%" Then 'looking for a reference
            cAPP.Load bNotFound, 0, "", txtArg, dteDate1, dteDate2
        Else ' looking for a document code
            cAPP.Load bNotFound, 0, "", "", dteDate1, dteDate2, , , txtArg
        End If
        If bNotFound Then
            ...
            If bNotFound Then
               ...
               If lngTPID > 0 Then
                    ...
                    Set cAPP = New c_APPs
                    SetDateArgs
                    cAPP.Load bNotFound, lngTPID, "", "", dteDate1, dteDate2
  '                  txtArg = ""
               End If
            End If
        Else
    ...
    Else
        ...
        Else
            SetDateArgs
        End If
        cAPP.Load bNotFound, 0, "", "", dteDate1, dteDate2
    End If
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cmdFind_LostFocus", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Form_Load", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Form_Unload(Cancel)", Cancel, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.LoadControls"
End Sub

Private Sub LoadArray()
    On Error GoTo errHandler
Dim objItem As d_APP
Dim itmList As ListItem
Dim lngIndex As Long
Dim i As Integer
    XA.Clear
    XA.ReDim 1, cAPP.Count, 1, 10
    For i = 1 To cAPP.Count
        With objItem
            XA.Value(i, 1) = cAPP(i).CustomerDisplay & (IIf(Len(Trim(cAPP(i).StaffNameB)) <= 1, "", "(" & Trim(cAPP(i).StaffNameB) & ")"))
          '  XA.Value(i, 1) = cAPP(i).TPNAME & (IIf(Len(Trim(cAPP(i).TPAccNum)) <= 1, "", "(" & Trim(cAPP(i).TPAccNum) & ")"))
            XA.Value(i, 2) = cAPP(i).DOCCode & cAPP(i).StaffNameB
            XA.Value(i, 3) = cAPP(i).DocDateF
            XA.Value(i, 4) = cAPP(i).DateForSort
            XA.Value(i, 5) = cAPP(i).TRID & "K"
            XA.Value(i, 6) = cAPP(i).StatusF
            XA.Value(i, 10) = cAPP(i).TPName
        End With
    Next
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.LoadArray"
End Sub
...
errHandler:
    ...
    If Err.Number = -2147217407 Then   'Access violation
        ...
        LogSaveToFile "Access violation in frmBrowseAPPs: Grid_DblClick"  'unknown source
        If errRepeat < 5 Then
            Resume Next
        Else
            LogSaveToFile "Access violation in frmBrowseAPPs: Grid_DblClick after 5 re-attempts"
    ...
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Grid_DblClick", , EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Grid_FetchRowStyle(Split,Bookmark,RowStyle)", Array(Split, Bookmark, _
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.Grid_HeadClick(ColIndex)", ColIndex, EA_NORERAISE
    HandleError
End Sub
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.GetRowType(ColIndex)", ColIndex
End Function
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.cmdPrint_Click", , EA_NORERAISE
    HandleError
End Sub
...
Dim strExecutable As String
    ...
    With xMLDoc
        ...
        .docInit "APP_1"
        .chCreate "APP"
            .elText = "Appros at " & Format(Now(), "dd/mm/yyyy HH:NN AM/PM")
        For i = 1 To cAPP.Count
            If IsAmongBookmarks(cAPP(i).TRID) Then
            .elCreateSibling "DetailLine", True
            .chCreate "Col_1"
                .elText = cAPP(i).TPName & (IIf(Len(Trim(cAPP(i).TPACCNum)) <= 1, "", "(" & Trim(cAPP(i).TPACCNum) & ")"))
            .elCreateSibling "Col_2"
                .elText = cAPP(i).DOCCode
            .elCreateSibling "Col_3"
                .elText = cAPP(i).DocDateF
            .elCreateSibling "Col_4"
                .elText = cAPP(i).StatusF
                .navUP
            End If
        Next i
    End With
...
'FINALLY PRODUCE THE .XML FILE
    strXML = oPC.SharedFolderRoot & "\TEMP\APP" & ".xml"
    With xMLDoc
...
''WRITE THE .RTF FILE
    If Not fs.FileExists(oPC.SharedFolderRoot & "\Templates\APP_RTF_1.xslt") Then
        MsgBox "You are missing the template file " & "APP_RTF_1.xslt. Contact Papyrus support." & vbCrLf & "The export is cancelled", vbOKOnly, "Can't do this"
    End If
    objXSL.async = False
    objXSL.ValidateOnParse = False
    objXSL.resolveExternals = False
    strPath = oPC.SharedFolderRoot & "\Templates\APP_RTF_1.xslt"
    ...
    strFilename = oPC.SharedFolderRoot & "\APP.RTF"
    i = 0
...
errHandler:
    If ErrMustStop Then Debug.Assert False: Resume
    ErrorIn "frmBrowseAPPs.ExportToXML"
End Function
